...
void find(char *curr_path, char *target) {
  ...
  c4:	90858593          	addi	a1,a1,-1784 # 9c8 <malloc+0xe6>
  c8:	4509                	li	a0,2
  ...
  fe:	8e658593          	addi	a1,a1,-1818 # 9e0 <malloc+0xfe>
 102:	4509                	li	a0,2
 104:	00000097          	auipc	ra,0x0
 108:	6f2080e7          	jalr	1778(ra) # 7f6 <fprintf>
    close(fd);
 10c:	8526                	mv	a0,s1
 ...
 11e:	8de50513          	addi	a0,a0,-1826 # 9f8 <malloc+0x116>
 122:	00000097          	auipc	ra,0x0
 126:	702080e7          	jalr	1794(ra) # 824 <printf>
 ...
 17c:	888a8a93          	addi	s5,s5,-1912 # a00 <malloc+0x11e>
          strcmp(de.name, "..") == 0)
 180:	00001b17          	auipc	s6,0x1
 184:	888b0b13          	addi	s6,s6,-1912 # a08 <malloc+0x126>
      if (de.inum == 0 || strcmp(de.name, ".") == 0 ||
...
int main(int argc, char *argv[])
{
 ...
 206:	80e58593          	addi	a1,a1,-2034 # a10 <malloc+0x12e>
 20a:	4509                	li	a0,2
 20c:	00000097          	auipc	ra,0x0
 210:	5ea080e7          	jalr	1514(ra) # 7f6 <fprintf>
    exit(1);
 214:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 594:	4b850513          	addi	a0,a0,1208 # a48 <digits>
 598:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 660:	3ecb8b93          	addi	s7,s7,1004 # a48 <digits>
 ...
 7a0:	2a490913          	addi	s2,s2,676 # a40 <malloc+0x15e>
        while(*s != 0){
...
free(void *ap)
{
 ...
 868:	1fc7b783          	ld	a5,508(a5) # a60 <freep>
...
malloc(uint nbytes)
{
 ...
 90a:	15a53503          	ld	a0,346(a0) # a60 <freep>
 ...
 932:	13290913          	addi	s2,s2,306 # a60 <freep>
  if(p == (char*)-1)
 936:	5afd                	li	s5,-1
 938:	a88d                	j	9aa <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 93a:	00000797          	auipc	a5,0x0
 93e:	12e78793          	addi	a5,a5,302 # a68 <base>
 942:	00000717          	auipc	a4,0x0
 946:	10f73f23          	sd	a5,286(a4) # a60 <freep>
 94a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 96c:	0ea73c23          	sd	a0,248(a4) # a60 <freep>
      return (void*)(p + 1);
