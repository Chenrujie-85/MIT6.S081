...
int main()
{
  ...
  32:	35a080e7          	jalr	858(ra) # 388 <close>
        close(p2[0]);
  ...
  50:	32c080e7          	jalr	812(ra) # 378 <read>
        printf("%d: received ping\n", getpid());
  54:	00000097          	auipc	ra,0x0
  58:	38c080e7          	jalr	908(ra) # 3e0 <getpid>
  5c:	85aa                	mv	a1,a0
  5e:	00001517          	auipc	a0,0x1
  62:	82250513          	addi	a0,a0,-2014 # 880 <malloc+0xea>
  ...
  7c:	308080e7          	jalr	776(ra) # 380 <write>
        exit(0);
  80:	4501                	li	a0,0
  ...
  92:	2fa080e7          	jalr	762(ra) # 388 <close>
        close(p2[1]);
  ...
  c2:	2ba080e7          	jalr	698(ra) # 378 <read>
        printf("%d: received pong\n", getpid());
  c6:	00000097          	auipc	ra,0x0
  ca:	31a080e7          	jalr	794(ra) # 3e0 <getpid>
  ce:	85aa                	mv	a1,a0
  d0:	00000517          	auipc	a0,0x0
  d4:	7c850513          	addi	a0,a0,1992 # 898 <malloc+0x102>
  d8:	00000097          	auipc	ra,0x0
  dc:	600080e7          	jalr	1536(ra) # 6d8 <printf>
        exit(0);
  e0:	4501                	li	a0,0
  e2:	00000097          	auipc	ra,0x0
  e6:	27e080e7          	jalr	638(ra) # 360 <exit>
...
free(void *ap)
{
 ...
 71c:	1b87b783          	ld	a5,440(a5) # 8d0 <freep>
 ...
 74a:	00e6ea63          	bltu	a3,a4,75e <free+0x50>
{
 ...
 78c:	14f73423          	sd	a5,328(a4) # 8d0 <freep>
}
 790:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7be:	11653503          	ld	a0,278(a0) # 8d0 <freep>
 ...
 7e6:	0ee90913          	addi	s2,s2,238 # 8d0 <freep>
  if(p == (char*)-1)
 7ea:	5afd                	li	s5,-1
 7ec:	a88d                	j	85e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7ee:	00000797          	auipc	a5,0x0
 7f2:	0ea78793          	addi	a5,a5,234 # 8d8 <base>
 7f6:	00000717          	auipc	a4,0x0
 7fa:	0cf73d23          	sd	a5,218(a4) # 8d0 <freep>
 7fe:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
