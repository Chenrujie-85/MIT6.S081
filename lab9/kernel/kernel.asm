...
0000000080000000 <_entry>:
    ...
    80000016:	1b3050ef          	jal	ra,800059c8 <start>
...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	368080e7          	jalr	872(ra) # 800063c2 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	408080e7          	jalr	1032(ra) # 80006476 <release>
}
    ...
    8000008e:	dee080e7          	jalr	-530(ra) # 80005e78 <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	23e080e7          	jalr	574(ra) # 80006332 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	296080e7          	jalr	662(ra) # 800063c2 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	332080e7          	jalr	818(ra) # 80006476 <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	308080e7          	jalr	776(ra) # 80006476 <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000360:	b66080e7          	jalr	-1178(ra) # 80005ec2 <printf>
  ...
  scheduler();        
    ...
    80000388:	a06080e7          	jalr	-1530(ra) # 80005d8a <consoleinit>
    printfinit();
    8000038c:	00006097          	auipc	ra,0x6
    80000390:	d1c080e7          	jalr	-740(ra) # 800060a8 <printfinit>
    printf("\n");
    80000394:	00008517          	auipc	a0,0x8
    80000398:	3cc50513          	addi	a0,a0,972 # 80008760 <syscalls+0x398>
    8000039c:	00006097          	auipc	ra,0x6
    800003a0:	b26080e7          	jalr	-1242(ra) # 80005ec2 <printf>
    printf("xv6 kernel is booting\n");
    800003a4:	00008517          	auipc	a0,0x8
    800003a8:	c7c50513          	addi	a0,a0,-900 # 80008020 <etext+0x20>
    800003ac:	00006097          	auipc	ra,0x6
    800003b0:	b16080e7          	jalr	-1258(ra) # 80005ec2 <printf>
    printf("\n");
    800003b4:	00008517          	auipc	a0,0x8
    800003b8:	3ac50513          	addi	a0,a0,940 # 80008760 <syscalls+0x398>
    800003bc:	00006097          	auipc	ra,0x6
    800003c0:	b06080e7          	jalr	-1274(ra) # 80005ec2 <printf>
    ...
    80000420:	056080e7          	jalr	86(ra) # 80005472 <virtio_disk_init>
    userinit();      // first user process
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    80000492:	9ea080e7          	jalr	-1558(ra) # 80005e78 <panic>
...
mappages(pagetable_t pagetable, uint64 va, uint64 size, uint64 pa, int perm)
{
  ...
  a = PGROUNDDOWN(va);
    ...
    *pte = PA2PTE(pa) | perm | PTE_V;
    ...
    8000058a:	8f2080e7          	jalr	-1806(ra) # 80005e78 <panic>
      panic("mappages: remap");
    8000058e:	00008517          	auipc	a0,0x8
    80000592:	ada50513          	addi	a0,a0,-1318 # 80008068 <etext+0x68>
    80000596:	00006097          	auipc	ra,0x6
    8000059a:	8e2080e7          	jalr	-1822(ra) # 80005e78 <panic>
    a += PGSIZE;
...
00000000800005e8 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    80000614:	868080e7          	jalr	-1944(ra) # 80005e78 <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    8000086e:	60e080e7          	jalr	1550(ra) # 80005e78 <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    800009b0:	4cc080e7          	jalr	1228(ra) # 80005e78 <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b06:	376080e7          	jalr	886(ra) # 80005e78 <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000d68:	114080e7          	jalr	276(ra) # 80005e78 <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000d94:	5a2080e7          	jalr	1442(ra) # 80006332 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000dac:	58a080e7          	jalr	1418(ra) # 80006332 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000de2:	554080e7          	jalr	1364(ra) # 80006332 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000e56:	524080e7          	jalr	1316(ra) # 80006376 <push_off>
  ...
  pop_off();
    ...
    80000e70:	5aa080e7          	jalr	1450(ra) # 80006416 <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000e94:	5e6080e7          	jalr	1510(ra) # 80006476 <release>
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000ee0:	4e6080e7          	jalr	1254(ra) # 800063c2 <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000efa:	580080e7          	jalr	1408(ra) # 80006476 <release>
}
...
0000000080001052 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001074:	352080e7          	jalr	850(ra) # 800063c2 <acquire>
    if(p->state == UNUSED) {
    ...
    80001082:	3f8080e7          	jalr	1016(ra) # 80006476 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  return p;
    ...
    80001100:	37a080e7          	jalr	890(ra) # 80006476 <release>
    return 0;
    ...
    80001118:	362080e7          	jalr	866(ra) # 80006476 <release>
    return 0;
...
0000000080001120 <userinit>:
{
  ...
  release(&p->lock);
    ...
    80001194:	2e6080e7          	jalr	742(ra) # 80006476 <release>
}
...
0000000080001216 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    800012ac:	1ce080e7          	jalr	462(ra) # 80006476 <release>
    return -1;
  ...
  release(&np->lock);
    ...
    800012fe:	17c080e7          	jalr	380(ra) # 80006476 <release>
  acquire(&wait_lock);
    ...
    80001310:	0b6080e7          	jalr	182(ra) # 800063c2 <acquire>
  np->parent = p;
    80001314:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001318:	8526                	mv	a0,s1
    8000131a:	00005097          	auipc	ra,0x5
    8000131e:	15c080e7          	jalr	348(ra) # 80006476 <release>
  acquire(&np->lock);
    80001322:	854e                	mv	a0,s3
    80001324:	00005097          	auipc	ra,0x5
    80001328:	09e080e7          	jalr	158(ra) # 800063c2 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001338:	142080e7          	jalr	322(ra) # 80006476 <release>
}
...
0000000080001352 <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800013d4:	0a6080e7          	jalr	166(ra) # 80006476 <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800013e6:	fe0080e7          	jalr	-32(ra) # 800063c2 <acquire>
      if(p->state == RUNNABLE) {
...
00000000800013f2 <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    8000140e:	f3e080e7          	jalr	-194(ra) # 80006348 <holding>
...
00000000800014c8 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    800014e0:	ee6080e7          	jalr	-282(ra) # 800063c2 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    800014f6:	f84080e7          	jalr	-124(ra) # 80006476 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    80001524:	ea2080e7          	jalr	-350(ra) # 800063c2 <acquire>
  release(lk);
    80001528:	854a                	mv	a0,s2
    8000152a:	00005097          	auipc	ra,0x5
    8000152e:	f4c080e7          	jalr	-180(ra) # 80006476 <release>
  ...
  release(&p->lock);
    ...
    8000154c:	f2e080e7          	jalr	-210(ra) # 80006476 <release>
  acquire(lk);
    80001550:	854a                	mv	a0,s2
    80001552:	00005097          	auipc	ra,0x5
    80001556:	e70080e7          	jalr	-400(ra) # 800063c2 <acquire>
}
...
0000000080001568 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80001598:	e2e080e7          	jalr	-466(ra) # 800063c2 <acquire>
    havekids = 0;
    ...
    80001636:	d90080e7          	jalr	-624(ra) # 800063c2 <acquire>
        if(np->state == ZOMBIE){
    ...
    80001646:	e34080e7          	jalr	-460(ra) # 80006476 <release>
        havekids = 1;
    ...
    80001662:	e18080e7          	jalr	-488(ra) # 80006476 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800016c0:	dba080e7          	jalr	-582(ra) # 80006476 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800016de:	ce8080e7          	jalr	-792(ra) # 800063c2 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
0000000080001760 <exit>:
{
  ...
  if(p == initproc)
    ...
    8000179c:	6e0080e7          	jalr	1760(ra) # 80005e78 <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    800017e6:	be0080e7          	jalr	-1056(ra) # 800063c2 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    80001806:	bc0080e7          	jalr	-1088(ra) # 800063c2 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    8000181a:	c60080e7          	jalr	-928(ra) # 80006476 <release>
  sched();
  ...
  panic("zombie exit");
    ...
    80001832:	64a080e7          	jalr	1610(ra) # 80005e78 <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000185c:	b6a080e7          	jalr	-1174(ra) # 800063c2 <acquire>
    if(p->pid == pid){
    ...
    8000186c:	c0e080e7          	jalr	-1010(ra) # 80006476 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    8000189a:	be0080e7          	jalr	-1056(ra) # 80006476 <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80001976:	550080e7          	jalr	1360(ra) # 80005ec2 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800019b8:	50e080e7          	jalr	1294(ra) # 80005ec2 <printf>
    printf("\n");
    800019bc:	8552                	mv	a0,s4
    800019be:	00004097          	auipc	ra,0x4
    800019c2:	504080e7          	jalr	1284(ra) # 80005ec2 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001a88:	8ae080e7          	jalr	-1874(ra) # 80006332 <initlock>
}
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001a9e:	7e678793          	addi	a5,a5,2022 # 80005280 <kernelvec>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001b62:	864080e7          	jalr	-1948(ra) # 800063c2 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001b82:	8f8080e7          	jalr	-1800(ra) # 80006476 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001bc6:	7c6080e7          	jalr	1990(ra) # 80005388 <plic_claim>
...
0000000080001c32 <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    80001c4c:	63878793          	addi	a5,a5,1592 # 80005280 <kernelvec>
  ...
  usertrapret();
    ...
    80001cb4:	1c8080e7          	jalr	456(ra) # 80005e78 <panic>
      exit(-1);
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001ce8:	1de080e7          	jalr	478(ra) # 80005ec2 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d00:	1c6080e7          	jalr	454(ra) # 80005ec2 <printf>
    p->killed = 1;
...
0000000080001d26 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001d80:	0fc080e7          	jalr	252(ra) # 80005e78 <panic>
    ...
    80001d90:	0ec080e7          	jalr	236(ra) # 80005e78 <panic>
    printf("scause %p\n", scause);
    ...
    80001da2:	124080e7          	jalr	292(ra) # 80005ec2 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001e56:	026080e7          	jalr	38(ra) # 80005e78 <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80001fbe:	f08080e7          	jalr	-248(ra) # 80005ec2 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    800020e4:	2e2080e7          	jalr	738(ra) # 800063c2 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    80002138:	342080e7          	jalr	834(ra) # 80006476 <release>
  return 0;
    ...
    8000215a:	320080e7          	jalr	800(ra) # 80006476 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    800021aa:	21c080e7          	jalr	540(ra) # 800063c2 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    800021c2:	2b8080e7          	jalr	696(ra) # 80006476 <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800021fa:	13c080e7          	jalr	316(ra) # 80006332 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002282:	144080e7          	jalr	324(ra) # 800063c2 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    800022c2:	1b8080e7          	jalr	440(ra) # 80006476 <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002300:	b7c080e7          	jalr	-1156(ra) # 80005e78 <panic>
      b->dev = dev;
    ...
    80002320:	15a080e7          	jalr	346(ra) # 80006476 <release>
      acquiresleep(&b->lock);
  ...
  return b;
    ...
    8000234c:	26e080e7          	jalr	622(ra) # 800055b6 <virtio_disk_rw>
    b->valid = 1;
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002376:	244080e7          	jalr	580(ra) # 800055b6 <virtio_disk_rw>
}
    ...
    80002390:	aec080e7          	jalr	-1300(ra) # 80005e78 <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    800023c8:	ffe080e7          	jalr	-2(ra) # 800063c2 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002412:	068080e7          	jalr	104(ra) # 80006476 <release>
}
    ...
    8000242e:	a4e080e7          	jalr	-1458(ra) # 80005e78 <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000244a:	f7c080e7          	jalr	-132(ra) # 800063c2 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    80002460:	01a080e7          	jalr	26(ra) # 80006476 <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002486:	f40080e7          	jalr	-192(ra) # 800063c2 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000249c:	fde080e7          	jalr	-34(ra) # 80006476 <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    80002522:	95a080e7          	jalr	-1702(ra) # 80005e78 <panic>
...
0000000080002526 <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    800025e8:	894080e7          	jalr	-1900(ra) # 80005e78 <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027f4:	688080e7          	jalr	1672(ra) # 80005e78 <panic>
...
00000000800027f8 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    80002818:	bae080e7          	jalr	-1106(ra) # 800063c2 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    8000285e:	c1c080e7          	jalr	-996(ra) # 80006476 <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    8000288e:	bec080e7          	jalr	-1044(ra) # 80006476 <release>
}
    ...
    800028b0:	5cc080e7          	jalr	1484(ra) # 80005e78 <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    80002930:	54c080e7          	jalr	1356(ra) # 80005e78 <panic>
...
0000000080002934 <iinit>:
{
  ...
  for(i = 0; i < NINODE; i++) {
    8000297e:	09048493          	addi	s1,s1,144
...
0000000080002994 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    80002a14:	468080e7          	jalr	1128(ra) # 80005e78 <panic>
...
0000000080002aee <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002b06:	8c0080e7          	jalr	-1856(ra) # 800063c2 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002b1c:	95e080e7          	jalr	-1698(ra) # 80006476 <release>
}
...
0000000080002b2c <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b68:	314080e7          	jalr	788(ra) # 80005e78 <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bea:	292080e7          	jalr	658(ra) # 80005e78 <panic>
...
0000000080002bee <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002c36:	246080e7          	jalr	582(ra) # 80005e78 <panic>
...
0000000080002d90 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002daa:	61c080e7          	jalr	1564(ra) # 800063c2 <acquire>
  ...
  release(&itable.lock);
    ...
    80002dc8:	6b2080e7          	jalr	1714(ra) # 80006476 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002dfc:	67e080e7          	jalr	1662(ra) # 80006476 <release>
    itrunc(ip);
    ...
    80002e32:	594080e7          	jalr	1428(ra) # 800063c2 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800030f2:	d8a080e7          	jalr	-630(ra) # 80005e78 <panic>
    ...
    80003102:	d7a080e7          	jalr	-646(ra) # 80005e78 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    800033d8:	1ec90913          	addi	s2,s2,492 # 800145c0 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800033fc:	1f878793          	addi	a5,a5,504 # 800145f0 <log+0x30>
    ...
    80003410:	1e860613          	addi	a2,a2,488 # 800145f4 <log+0x34>
...
0000000080003442 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003446:	1aa7a783          	lw	a5,426(a5) # 800145ec <log+0x2c>
    8000344a:	0af05d63          	blez	a5,80003504 <install_trans+0xc2>
{
    ...
    80003468:	18ca8a93          	addi	s5,s5,396 # 800145f0 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    8000346c:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    8000346e:	00011997          	auipc	s3,0x11
    80003472:	15298993          	addi	s3,s3,338 # 800145c0 <log>
...
0000000080003506 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    8000351c:	0a848493          	addi	s1,s1,168 # 800145c0 <log>
    ...
    8000352e:	e08080e7          	jalr	-504(ra) # 80006332 <initlock>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000355c:	09868693          	addi	a3,a3,152 # 800145f0 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003590:	0607a023          	sw	zero,96(a5) # 800145ec <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800035ba:	00a50513          	addi	a0,a0,10 # 800145c0 <log>
    800035be:	00003097          	auipc	ra,0x3
    800035c2:	e04080e7          	jalr	-508(ra) # 800063c2 <acquire>
  while(1){
    if(log.committing){
    800035c6:	00011497          	auipc	s1,0x11
    800035ca:	ffa48493          	addi	s1,s1,-6 # 800145c0 <log>
      sleep(&log, &log.lock);
    ...
    80003610:	fb450513          	addi	a0,a0,-76 # 800145c0 <log>
    80003614:	d114                	sw	a3,32(a0)
      release(&log.lock);
    80003616:	00003097          	auipc	ra,0x3
    8000361a:	e60080e7          	jalr	-416(ra) # 80006476 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003640:	f8448493          	addi	s1,s1,-124 # 800145c0 <log>
    80003644:	8526                	mv	a0,s1
    80003646:	00003097          	auipc	ra,0x3
    8000364a:	d7c080e7          	jalr	-644(ra) # 800063c2 <acquire>
  log.outstanding -= 1;
  ...
  if(log.outstanding == 0){
    ...
    80003664:	f6048493          	addi	s1,s1,-160 # 800145c0 <log>
  ...
  release(&log.lock);
    ...
    80003672:	e08080e7          	jalr	-504(ra) # 80006476 <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80003680:	f4448493          	addi	s1,s1,-188 # 800145c0 <log>
    80003684:	8526                	mv	a0,s1
    80003686:	00003097          	auipc	ra,0x3
    8000368a:	d3c080e7          	jalr	-708(ra) # 800063c2 <acquire>
    log.committing = 0;
    ...
    800036a2:	dd8080e7          	jalr	-552(ra) # 80006476 <release>
}
    ...
    800036c4:	7b8080e7          	jalr	1976(ra) # 80005e78 <panic>
    wakeup(&log);
    800036c8:	00011497          	auipc	s1,0x11
    800036cc:	ef848493          	addi	s1,s1,-264 # 800145c0 <log>
  ...
  release(&log.lock);
    ...
    800036e0:	d9a080e7          	jalr	-614(ra) # 80006476 <release>
  if(do_commit){
    800036e4:	b7c9                	j	800036a6 <end_op+0x7c>
  for (tail = 0; tail < log.lh.n; tail++) {
    800036e6:	00011a97          	auipc	s5,0x11
    800036ea:	f0aa8a93          	addi	s5,s5,-246 # 800145f0 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    800036ee:	00011a17          	auipc	s4,0x11
    800036f2:	ed2a0a13          	addi	s4,s4,-302 # 800145c0 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003774:	e607ae23          	sw	zero,-388(a5) # 800145ec <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80003794:	e3090913          	addi	s2,s2,-464 # 800145c0 <log>
    80003798:	854a                	mv	a0,s2
    8000379a:	00003097          	auipc	ra,0x3
    8000379e:	c28080e7          	jalr	-984(ra) # 800063c2 <acquire>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800037d2:	e2270713          	addi	a4,a4,-478 # 800145f0 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    800037ee:	dd678793          	addi	a5,a5,-554 # 800145c0 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80003806:	dbe70713          	addi	a4,a4,-578 # 800145c0 <log>
  ...
  release(&log.lock);
    ...
    80003850:	d7450513          	addi	a0,a0,-652 # 800145c0 <log>
    80003854:	00003097          	auipc	ra,0x3
    80003858:	c22080e7          	jalr	-990(ra) # 80006476 <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003886:	ab0080e7          	jalr	-1360(ra) # 80006332 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800038ba:	b0c080e7          	jalr	-1268(ra) # 800063c2 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800038e8:	b92080e7          	jalr	-1134(ra) # 80006476 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003910:	ab6080e7          	jalr	-1354(ra) # 800063c2 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    8000392c:	b4e080e7          	jalr	-1202(ra) # 80006476 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003956:	a70080e7          	jalr	-1424(ra) # 800063c2 <acquire>
  ...
  release(&lk->lk);
    ...
    80003966:	b14080e7          	jalr	-1260(ra) # 80006476 <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800039a6:	d6650513          	addi	a0,a0,-666 # 80014708 <ftable>
    800039aa:	00003097          	auipc	ra,0x3
    800039ae:	988080e7          	jalr	-1656(ra) # 80006332 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800039c8:	d4450513          	addi	a0,a0,-700 # 80014708 <ftable>
    800039cc:	00003097          	auipc	ra,0x3
    800039d0:	9f6080e7          	jalr	-1546(ra) # 800063c2 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    800039d4:	00011497          	auipc	s1,0x11
    800039d8:	d4c48493          	addi	s1,s1,-692 # 80014720 <ftable+0x18>
    800039dc:	00012717          	auipc	a4,0x12
    800039e0:	ce470713          	addi	a4,a4,-796 # 800156c0 <ftable+0xfb8>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    800039f4:	d1850513          	addi	a0,a0,-744 # 80014708 <ftable>
    800039f8:	00003097          	auipc	ra,0x3
    800039fc:	a7e080e7          	jalr	-1410(ra) # 80006476 <release>
  return 0;
    ...
    80003a0c:	d0050513          	addi	a0,a0,-768 # 80014708 <ftable>
    80003a10:	00003097          	auipc	ra,0x3
    80003a14:	a66080e7          	jalr	-1434(ra) # 80006476 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003a34:	cd850513          	addi	a0,a0,-808 # 80014708 <ftable>
    80003a38:	00003097          	auipc	ra,0x3
    80003a3c:	98a080e7          	jalr	-1654(ra) # 800063c2 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003a4e:	cbe50513          	addi	a0,a0,-834 # 80014708 <ftable>
    80003a52:	00003097          	auipc	ra,0x3
    80003a56:	a24080e7          	jalr	-1500(ra) # 80006476 <release>
  return f;
}
    ...
    80003a72:	40a080e7          	jalr	1034(ra) # 80005e78 <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003a8e:	c7e50513          	addi	a0,a0,-898 # 80014708 <ftable>
    80003a92:	00003097          	auipc	ra,0x3
    80003a96:	930080e7          	jalr	-1744(ra) # 800063c2 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003ac8:	c4450513          	addi	a0,a0,-956 # 80014708 <ftable>
    80003acc:	00003097          	auipc	ra,0x3
    80003ad0:	9aa080e7          	jalr	-1622(ra) # 80006476 <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003b0a:	372080e7          	jalr	882(ra) # 80005e78 <panic>
    release(&ftable.lock);
    80003b0e:	00011517          	auipc	a0,0x11
    80003b12:	bfa50513          	addi	a0,a0,-1030 # 80014708 <ftable>
    80003b16:	00003097          	auipc	ra,0x3
    80003b1a:	960080e7          	jalr	-1696(ra) # 80006476 <release>
  }
}
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003c44:	a2870713          	addi	a4,a4,-1496 # 80014668 <devsw>
    ...
    80003c62:	21a080e7          	jalr	538(ra) # 80005e78 <panic>
    return -1;
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003ce0:	00011717          	auipc	a4,0x11
    80003ce4:	98870713          	addi	a4,a4,-1656 # 80014668 <devsw>
  ...
  return ret;
    ...
    80003d96:	0e6080e7          	jalr	230(ra) # 80005e78 <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003e06:	530080e7          	jalr	1328(ra) # 80006332 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003e94:	532080e7          	jalr	1330(ra) # 800063c2 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003eb8:	5c2080e7          	jalr	1474(ra) # 80006476 <release>
    kfree((char*)pi);
    ...
    80003eea:	590080e7          	jalr	1424(ra) # 80006476 <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f20:	4a6080e7          	jalr	1190(ra) # 800063c2 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003f3e:	53c080e7          	jalr	1340(ra) # 80006476 <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003fe0:	49a080e7          	jalr	1178(ra) # 80006476 <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80004016:	3b0080e7          	jalr	944(ra) # 800063c2 <acquire>
  ...
  release(&pi->lock);
    ...
    800040aa:	3d0080e7          	jalr	976(ra) # 80006476 <release>
  return i;
}
    ...
    800040ca:	3b0080e7          	jalr	944(ra) # 80006476 <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    800041d2:	caa080e7          	jalr	-854(ra) # 80005e78 <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    80004604:	878080e7          	jalr	-1928(ra) # 80005e78 <panic>
    dp->nlink++;  // for ".."
    ...
    80004656:	00002097          	auipc	ra,0x2
    8000465a:	822080e7          	jalr	-2014(ra) # 80005e78 <panic>
    panic("create: dirlink");
    8000465e:	00004517          	auipc	a0,0x4
    80004662:	04250513          	addi	a0,a0,66 # 800086a0 <syscalls+0x2d8>
    80004666:	00002097          	auipc	ra,0x2
    8000466a:	812080e7          	jalr	-2030(ra) # 80005e78 <panic>
    return 0;
...
0000000080004972 <sys_unlink>:
{
  ...
  return 0;
    ...
    80004a9e:	3de080e7          	jalr	990(ra) # 80005e78 <panic>
...
0000000080004b44 <next_ip>:

struct inode* next_ip(struct inode* ip)
{
    ...
    80004b50:	e1d2                	sd	s4,192(sp)
    80004b52:	fd56                	sd	s5,184(sp)
    80004b54:	1980                	addi	s0,sp,240
    80004b56:	84aa                	mv	s1,a0
    80004b58:	f9840993          	addi	s3,s0,-104
  int visited[MAXLINK];
  int i, j;
  char target[MAXPATH];
  ...
  for(i = 0; i < MAXLINK; ++i)
    ...
    80004b5e:	4a11                	li	s4,4
  for(i = 0; i < MAXLINK; ++i)
    80004b60:	4aa9                	li	s5,10
    visited[i] = ip->inum;
    80004b62:	40dc                	lw	a5,4(s1)
    80004b64:	00f9a023          	sw	a5,0(s3)
    if(readi(ip, 0, (uint64)target, 0, MAXPATH) <= 0) {
    80004b68:	08000713          	li	a4,128
    80004b6c:	4681                	li	a3,0
    80004b6e:	f1840613          	addi	a2,s0,-232
    80004b72:	4581                	li	a1,0
    80004b74:	8526                	mv	a0,s1
    80004b76:	ffffe097          	auipc	ra,0xffffe
    80004b7a:	314080e7          	jalr	788(ra) # 80002e8a <readi>
    80004b7e:	06a05863          	blez	a0,80004bee <next_ip+0xaa>
    iunlockput(ip);
    80004b82:	8526                	mv	a0,s1
    80004b84:	ffffe097          	auipc	ra,0xffffe
    80004b88:	2b4080e7          	jalr	692(ra) # 80002e38 <iunlockput>
    if((ip = namei(target)) == 0) {
    80004b8c:	f1840513          	addi	a0,s0,-232
    80004b90:	ffffe097          	auipc	ra,0xffffe
    80004b94:	7fe080e7          	jalr	2046(ra) # 8000338e <namei>
    80004b98:	84aa                	mv	s1,a0
    80004b9a:	c92d                	beqz	a0,80004c0c <next_ip+0xc8>
    for(j = 0; j <= i; ++j) {
    80004b9c:	00094d63          	bltz	s2,80004bb6 <next_ip+0x72>
      if(ip->inum == visited[j]) {
    80004ba0:	4150                	lw	a2,4(a0)
    80004ba2:	f9840793          	addi	a5,s0,-104
    for(j = 0; j <= i; ++j) {
    80004ba6:	4701                	li	a4,0
      if(ip->inum == visited[j]) {
    80004ba8:	4394                	lw	a3,0(a5)
    80004baa:	06c68d63          	beq	a3,a2,80004c24 <next_ip+0xe0>
    for(j = 0; j <= i; ++j) {
    80004bae:	2705                	addiw	a4,a4,1
    80004bb0:	0791                	addi	a5,a5,4
    80004bb2:	fee95be3          	bge	s2,a4,80004ba8 <next_ip+0x64>
    ilock(ip);
    80004bb6:	8526                	mv	a0,s1
    80004bb8:	ffffe097          	auipc	ra,0xffffe
    80004bbc:	f74080e7          	jalr	-140(ra) # 80002b2c <ilock>
    if(ip->type != T_SYMLINK) {
    80004bc0:	04449783          	lh	a5,68(s1)
    80004bc4:	09479263          	bne	a5,s4,80004c48 <next_ip+0x104>
  for(i = 0; i < MAXLINK; ++i)
    80004bc8:	2905                	addiw	s2,s2,1
    80004bca:	0991                	addi	s3,s3,4
    80004bcc:	f9591be3          	bne	s2,s5,80004b62 <next_ip+0x1e>
      return ip;
    }
  }
  ...
  iunlockput(ip);
    ...
    80004bd6:	266080e7          	jalr	614(ra) # 80002e38 <iunlockput>
  printf("open_symlink: the depth of links reaches the limit\n");
    80004bda:	00004517          	auipc	a0,0x4
    80004bde:	b8e50513          	addi	a0,a0,-1138 # 80008768 <syscalls+0x3a0>
    80004be2:	00001097          	auipc	ra,0x1
    80004be6:	2e0080e7          	jalr	736(ra) # 80005ec2 <printf>
  return 0;
    80004bea:	4501                	li	a0,0
    80004bec:	a0a9                	j	80004c36 <next_ip+0xf2>
      iunlockput(ip);
    80004bee:	8526                	mv	a0,s1
    80004bf0:	ffffe097          	auipc	ra,0xffffe
    80004bf4:	248080e7          	jalr	584(ra) # 80002e38 <iunlockput>
      printf("open_symlink: open symlink failed\n");
    80004bf8:	00004517          	auipc	a0,0x4
    80004bfc:	af850513          	addi	a0,a0,-1288 # 800086f0 <syscalls+0x328>
    80004c00:	00001097          	auipc	ra,0x1
    80004c04:	2c2080e7          	jalr	706(ra) # 80005ec2 <printf>
      return 0;
    80004c08:	4501                	li	a0,0
    80004c0a:	a035                	j	80004c36 <next_ip+0xf2>
      printf("open_symlink: path \"%s\" is not exist\n", target);
    80004c0c:	f1840593          	addi	a1,s0,-232
    80004c10:	00004517          	auipc	a0,0x4
    80004c14:	b0850513          	addi	a0,a0,-1272 # 80008718 <syscalls+0x350>
    80004c18:	00001097          	auipc	ra,0x1
    80004c1c:	2aa080e7          	jalr	682(ra) # 80005ec2 <printf>
      return 0;
    80004c20:	8526                	mv	a0,s1
    80004c22:	a811                	j	80004c36 <next_ip+0xf2>
        printf("open_symlink: links form a cycle\n");
    80004c24:	00004517          	auipc	a0,0x4
    80004c28:	b1c50513          	addi	a0,a0,-1252 # 80008740 <syscalls+0x378>
    80004c2c:	00001097          	auipc	ra,0x1
    80004c30:	296080e7          	jalr	662(ra) # 80005ec2 <printf>
        return 0;
    80004c34:	4501                	li	a0,0
}
    80004c36:	70ae                	ld	ra,232(sp)
    80004c38:	740e                	ld	s0,224(sp)
    80004c3a:	64ee                	ld	s1,216(sp)
    80004c3c:	694e                	ld	s2,208(sp)
    80004c3e:	69ae                	ld	s3,200(sp)
    80004c40:	6a0e                	ld	s4,192(sp)
    80004c42:	7aea                	ld	s5,184(sp)
    80004c44:	616d                	addi	sp,sp,240
    80004c46:	8082                	ret
    if((ip = namei(target)) == 0) {
    80004c48:	8526                	mv	a0,s1
    80004c4a:	b7f5                	j	80004c36 <next_ip+0xf2>
...
sys_open(void)
{
    80004c4c:	7131                	addi	sp,sp,-192
    80004c4e:	fd06                	sd	ra,184(sp)
    80004c50:	f922                	sd	s0,176(sp)
    80004c52:	f526                	sd	s1,168(sp)
    80004c54:	f14a                	sd	s2,160(sp)
    80004c56:	ed4e                	sd	s3,152(sp)
    80004c58:	0180                	addi	s0,sp,192
  int fd, omode;
  struct file *f;
  struct inode *ip;
  int n;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    80004c5e:	f5040593          	addi	a1,s0,-176
    80004c62:	4501                	li	a0,0
    80004c64:	ffffd097          	auipc	ra,0xffffd
    80004c68:	2d4080e7          	jalr	724(ra) # 80001f38 <argstr>
    return -1;
    80004c6c:	54fd                	li	s1,-1
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    80004c6e:	0c054763          	bltz	a0,80004d3c <sys_open+0xf0>
    80004c72:	f4c40593          	addi	a1,s0,-180
    80004c76:	4505                	li	a0,1
    80004c78:	ffffd097          	auipc	ra,0xffffd
    80004c7c:	27c080e7          	jalr	636(ra) # 80001ef4 <argint>
    80004c80:	0a054e63          	bltz	a0,80004d3c <sys_open+0xf0>

  begin_op();
    80004c84:	fffff097          	auipc	ra,0xfffff
    80004c88:	926080e7          	jalr	-1754(ra) # 800035aa <begin_op>

  if(omode & O_CREATE){
    80004c8c:	f4c42783          	lw	a5,-180(s0)
    80004c90:	2007f793          	andi	a5,a5,512
    80004c94:	c3e9                	beqz	a5,80004d56 <sys_open+0x10a>
    ip = create(path, T_FILE, 0, 0);
    80004c96:	4681                	li	a3,0
    80004c98:	4601                	li	a2,0
    80004c9a:	4589                	li	a1,2
    80004c9c:	f5040513          	addi	a0,s0,-176
    80004ca0:	00000097          	auipc	ra,0x0
    80004ca4:	86a080e7          	jalr	-1942(ra) # 8000450a <create>
    80004ca8:	892a                	mv	s2,a0
    if(ip == 0){
    80004caa:	c14d                	beqz	a0,80004d4c <sys_open+0x100>
      end_op();
      return -1;
    }
  }
  ...
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    80004cac:	04491783          	lh	a5,68(s2)
    80004cb0:	0007869b          	sext.w	a3,a5
    80004cb4:	470d                	li	a4,3
    80004cb6:	0ee68563          	beq	a3,a4,80004da0 <sys_open+0x154>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_SYMLINK && (omode & O_NOFOLLOW) == 0)
    ...
    80004cbc:	4711                	li	a4,4
    80004cbe:	00e79763          	bne	a5,a4,80004ccc <sys_open+0x80>
    80004cc2:	f4c42783          	lw	a5,-180(s0)
    80004cc6:	1007f793          	andi	a5,a5,256
    80004cca:	cbfd                	beqz	a5,80004dc0 <sys_open+0x174>
      end_op();
      return -1;
    }
  }
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    ...
    80004cd0:	cee080e7          	jalr	-786(ra) # 800039ba <filealloc>
    80004cd4:	89aa                	mv	s3,a0
    80004cd6:	12050463          	beqz	a0,80004dfe <sys_open+0x1b2>
    80004cda:	fffff097          	auipc	ra,0xfffff
    80004cde:	7ee080e7          	jalr	2030(ra) # 800044c8 <fdalloc>
    80004ce2:	84aa                	mv	s1,a0
    80004ce4:	10054863          	bltz	a0,80004df4 <sys_open+0x1a8>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_DEVICE){
    80004ce8:	04491703          	lh	a4,68(s2)
    80004cec:	478d                	li	a5,3
    80004cee:	0ef70663          	beq	a4,a5,80004dda <sys_open+0x18e>
    f->type = FD_DEVICE;
    f->major = ip->major;
  } else {
    f->type = FD_INODE;
  ...
  if((omode & O_TRUNC) && ip->type == T_FILE){
    ...
    80004d1e:	c791                	beqz	a5,80004d2a <sys_open+0xde>
    80004d20:	04491703          	lh	a4,68(s2)
    80004d24:	4789                	li	a5,2
    80004d26:	0cf70163          	beq	a4,a5,80004de8 <sys_open+0x19c>
    itrunc(ip);
  }
  ...
  iunlock(ip);
    ...
    80004d30:	ec2080e7          	jalr	-318(ra) # 80002bee <iunlock>
  end_op();
    80004d34:	fffff097          	auipc	ra,0xfffff
    80004d38:	8f6080e7          	jalr	-1802(ra) # 8000362a <end_op>
  ...
  return fd;
    ...
    80004d50:	8de080e7          	jalr	-1826(ra) # 8000362a <end_op>
      return -1;
    80004d54:	b7e5                	j	80004d3c <sys_open+0xf0>
    if((ip = namei(path)) == 0){
    80004d56:	f5040513          	addi	a0,s0,-176
    80004d5a:	ffffe097          	auipc	ra,0xffffe
    80004d5e:	634080e7          	jalr	1588(ra) # 8000338e <namei>
    80004d62:	892a                	mv	s2,a0
    80004d64:	c905                	beqz	a0,80004d94 <sys_open+0x148>
    ilock(ip);
    80004d66:	ffffe097          	auipc	ra,0xffffe
    80004d6a:	dc6080e7          	jalr	-570(ra) # 80002b2c <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
    80004d6e:	04491703          	lh	a4,68(s2)
    80004d72:	4785                	li	a5,1
    80004d74:	f2f71ce3          	bne	a4,a5,80004cac <sys_open+0x60>
    80004d78:	f4c42783          	lw	a5,-180(s0)
    80004d7c:	dba1                	beqz	a5,80004ccc <sys_open+0x80>
      iunlockput(ip);
    80004d7e:	854a                	mv	a0,s2
    80004d80:	ffffe097          	auipc	ra,0xffffe
    80004d84:	0b8080e7          	jalr	184(ra) # 80002e38 <iunlockput>
      end_op();
    80004d88:	fffff097          	auipc	ra,0xfffff
    80004d8c:	8a2080e7          	jalr	-1886(ra) # 8000362a <end_op>
      return -1;
    80004d90:	54fd                	li	s1,-1
    80004d92:	b76d                	j	80004d3c <sys_open+0xf0>
      end_op();
    80004d94:	fffff097          	auipc	ra,0xfffff
    80004d98:	896080e7          	jalr	-1898(ra) # 8000362a <end_op>
      return -1;
    80004d9c:	54fd                	li	s1,-1
    80004d9e:	bf79                	j	80004d3c <sys_open+0xf0>
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    80004da0:	04695703          	lhu	a4,70(s2)
    80004da4:	47a5                	li	a5,9
    80004da6:	f2e7f3e3          	bgeu	a5,a4,80004ccc <sys_open+0x80>
    iunlockput(ip);
    80004daa:	854a                	mv	a0,s2
    80004dac:	ffffe097          	auipc	ra,0xffffe
    80004db0:	08c080e7          	jalr	140(ra) # 80002e38 <iunlockput>
    end_op();
    80004db4:	fffff097          	auipc	ra,0xfffff
    80004db8:	876080e7          	jalr	-1930(ra) # 8000362a <end_op>
    return -1;
    80004dbc:	54fd                	li	s1,-1
    80004dbe:	bfbd                	j	80004d3c <sys_open+0xf0>
    if((ip = next_ip(ip)) == 0)
    80004dc0:	854a                	mv	a0,s2
    80004dc2:	00000097          	auipc	ra,0x0
    80004dc6:	d82080e7          	jalr	-638(ra) # 80004b44 <next_ip>
    80004dca:	892a                	mv	s2,a0
    80004dcc:	f101                	bnez	a0,80004ccc <sys_open+0x80>
      end_op();
    80004dce:	fffff097          	auipc	ra,0xfffff
    80004dd2:	85c080e7          	jalr	-1956(ra) # 8000362a <end_op>
      return -1;
    80004dd6:	54fd                	li	s1,-1
    80004dd8:	b795                	j	80004d3c <sys_open+0xf0>
    f->type = FD_DEVICE;
    80004dda:	00f9a023          	sw	a5,0(s3)
    f->major = ip->major;
    80004dde:	04691783          	lh	a5,70(s2)
    80004de2:	02f99223          	sh	a5,36(s3)
    80004de6:	bf19                	j	80004cfc <sys_open+0xb0>
    itrunc(ip);
    80004de8:	854a                	mv	a0,s2
    80004dea:	ffffe097          	auipc	ra,0xffffe
    80004dee:	e50080e7          	jalr	-432(ra) # 80002c3a <itrunc>
    80004df2:	bf25                	j	80004d2a <sys_open+0xde>
      fileclose(f);
    80004df4:	854e                	mv	a0,s3
    80004df6:	fffff097          	auipc	ra,0xfffff
    80004dfa:	c80080e7          	jalr	-896(ra) # 80003a76 <fileclose>
    iunlockput(ip);
    80004dfe:	854a                	mv	a0,s2
    80004e00:	ffffe097          	auipc	ra,0xffffe
    80004e04:	038080e7          	jalr	56(ra) # 80002e38 <iunlockput>
    end_op();
    80004e08:	fffff097          	auipc	ra,0xfffff
    80004e0c:	822080e7          	jalr	-2014(ra) # 8000362a <end_op>
    return -1;
    80004e10:	54fd                	li	s1,-1
    80004e12:	b72d                	j	80004d3c <sys_open+0xf0>

0000000080004e14 <sys_mkdir>:

uint64
sys_mkdir(void)
{
    80004e14:	7175                	addi	sp,sp,-144
    80004e16:	e506                	sd	ra,136(sp)
    80004e18:	e122                	sd	s0,128(sp)
    80004e1a:	0900                	addi	s0,sp,144
  char path[MAXPATH];
  struct inode *ip;

  begin_op();
    80004e1c:	ffffe097          	auipc	ra,0xffffe
    80004e20:	78e080e7          	jalr	1934(ra) # 800035aa <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80004e32:	10a080e7          	jalr	266(ra) # 80001f38 <argstr>
    80004e36:	02054963          	bltz	a0,80004e68 <sys_mkdir+0x54>
    80004e3a:	4681                	li	a3,0
    80004e3c:	4601                	li	a2,0
    80004e3e:	4585                	li	a1,1
    80004e40:	f7040513          	addi	a0,s0,-144
    80004e44:	fffff097          	auipc	ra,0xfffff
    80004e48:	6c6080e7          	jalr	1734(ra) # 8000450a <create>
    80004e4c:	cd11                	beqz	a0,80004e68 <sys_mkdir+0x54>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80004e4e:	ffffe097          	auipc	ra,0xffffe
    80004e52:	fea080e7          	jalr	-22(ra) # 80002e38 <iunlockput>
  end_op();
    80004e56:	ffffe097          	auipc	ra,0xffffe
    80004e5a:	7d4080e7          	jalr	2004(ra) # 8000362a <end_op>
  return 0;
    80004e5e:	4501                	li	a0,0
}
    80004e60:	60aa                	ld	ra,136(sp)
    80004e62:	640a                	ld	s0,128(sp)
    80004e64:	6149                	addi	sp,sp,144
    80004e66:	8082                	ret
    end_op();
    80004e68:	ffffe097          	auipc	ra,0xffffe
    80004e6c:	7c2080e7          	jalr	1986(ra) # 8000362a <end_op>
    return -1;
    80004e70:	557d                	li	a0,-1
    80004e72:	b7fd                	j	80004e60 <sys_mkdir+0x4c>

0000000080004e74 <sys_mknod>:

uint64
sys_mknod(void)
{
    80004e74:	7135                	addi	sp,sp,-160
    80004e76:	ed06                	sd	ra,152(sp)
    80004e78:	e922                	sd	s0,144(sp)
  ...
  begin_op();
    ...
    80004e80:	72e080e7          	jalr	1838(ra) # 800035aa <begin_op>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80004e84:	08000613          	li	a2,128
    80004e88:	f7040593          	addi	a1,s0,-144
    80004e8c:	4501                	li	a0,0
    80004e8e:	ffffd097          	auipc	ra,0xffffd
    80004e92:	0aa080e7          	jalr	170(ra) # 80001f38 <argstr>
    80004e96:	04054a63          	bltz	a0,80004eea <sys_mknod+0x76>
     argint(1, &major) < 0 ||
    80004e9a:	f6c40593          	addi	a1,s0,-148
    80004e9e:	4505                	li	a0,1
    80004ea0:	ffffd097          	auipc	ra,0xffffd
    80004ea4:	054080e7          	jalr	84(ra) # 80001ef4 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    80004ea8:	04054163          	bltz	a0,80004eea <sys_mknod+0x76>
     argint(2, &minor) < 0 ||
    80004eac:	f6840593          	addi	a1,s0,-152
    80004eb0:	4509                	li	a0,2
    80004eb2:	ffffd097          	auipc	ra,0xffffd
    80004eb6:	042080e7          	jalr	66(ra) # 80001ef4 <argint>
     argint(1, &major) < 0 ||
    80004eba:	02054863          	bltz	a0,80004eea <sys_mknod+0x76>
    ...
    80004ed0:	63e080e7          	jalr	1598(ra) # 8000450a <create>
     argint(2, &minor) < 0 ||
    80004ed4:	c919                	beqz	a0,80004eea <sys_mknod+0x76>
    end_op();
    return -1;
  }
  iunlockput(ip);
    80004ed6:	ffffe097          	auipc	ra,0xffffe
    80004eda:	f62080e7          	jalr	-158(ra) # 80002e38 <iunlockput>
  end_op();
    80004ede:	ffffe097          	auipc	ra,0xffffe
    80004ee2:	74c080e7          	jalr	1868(ra) # 8000362a <end_op>
  return 0;
    80004ee6:	4501                	li	a0,0
    80004ee8:	a031                	j	80004ef4 <sys_mknod+0x80>
    end_op();
    80004eea:	ffffe097          	auipc	ra,0xffffe
    80004eee:	740080e7          	jalr	1856(ra) # 8000362a <end_op>
    return -1;
    80004ef2:	557d                	li	a0,-1
}
    80004ef4:	60ea                	ld	ra,152(sp)
    80004ef6:	644a                	ld	s0,144(sp)
    80004ef8:	610d                	addi	sp,sp,160
    80004efa:	8082                	ret

0000000080004efc <sys_chdir>:
...
sys_chdir(void)
{
    ...
    80004f02:	e526                	sd	s1,136(sp)
    80004f04:	e14a                	sd	s2,128(sp)
    80004f06:	1100                	addi	s0,sp,160
  char path[MAXPATH];
  struct inode *ip;
  struct proc *p = myproc();
    80004f08:	ffffc097          	auipc	ra,0xffffc
    80004f0c:	f40080e7          	jalr	-192(ra) # 80000e48 <myproc>
    80004f10:	892a                	mv	s2,a0
  
  begin_op();
    80004f12:	ffffe097          	auipc	ra,0xffffe
    80004f16:	698080e7          	jalr	1688(ra) # 800035aa <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    80004f1a:	08000613          	li	a2,128
    80004f1e:	f6040593          	addi	a1,s0,-160
    80004f22:	4501                	li	a0,0
    80004f24:	ffffd097          	auipc	ra,0xffffd
    80004f28:	014080e7          	jalr	20(ra) # 80001f38 <argstr>
    80004f2c:	04054b63          	bltz	a0,80004f82 <sys_chdir+0x86>
    80004f30:	f6040513          	addi	a0,s0,-160
    80004f34:	ffffe097          	auipc	ra,0xffffe
    80004f38:	45a080e7          	jalr	1114(ra) # 8000338e <namei>
    80004f3c:	84aa                	mv	s1,a0
    80004f3e:	c131                	beqz	a0,80004f82 <sys_chdir+0x86>
    end_op();
    return -1;
  }
  ilock(ip);
    80004f40:	ffffe097          	auipc	ra,0xffffe
    80004f44:	bec080e7          	jalr	-1044(ra) # 80002b2c <ilock>
  if(ip->type != T_DIR){
    80004f48:	04449703          	lh	a4,68(s1)
    80004f4c:	4785                	li	a5,1
    80004f4e:	04f71063          	bne	a4,a5,80004f8e <sys_chdir+0x92>
    iunlockput(ip);
    end_op();
    return -1;
  }
  iunlock(ip);
    ...
    80004f58:	c9a080e7          	jalr	-870(ra) # 80002bee <iunlock>
  iput(p->cwd);
    80004f5c:	15093503          	ld	a0,336(s2)
    80004f60:	ffffe097          	auipc	ra,0xffffe
    80004f64:	e30080e7          	jalr	-464(ra) # 80002d90 <iput>
  end_op();
    80004f68:	ffffe097          	auipc	ra,0xffffe
    80004f6c:	6c2080e7          	jalr	1730(ra) # 8000362a <end_op>
  p->cwd = ip;
    80004f70:	14993823          	sd	s1,336(s2)
  return 0;
    80004f74:	4501                	li	a0,0
}
    80004f76:	60ea                	ld	ra,152(sp)
    80004f78:	644a                	ld	s0,144(sp)
    80004f7a:	64aa                	ld	s1,136(sp)
    80004f7c:	690a                	ld	s2,128(sp)
    80004f7e:	610d                	addi	sp,sp,160
    80004f80:	8082                	ret
    end_op();
    80004f82:	ffffe097          	auipc	ra,0xffffe
    80004f86:	6a8080e7          	jalr	1704(ra) # 8000362a <end_op>
    return -1;
    80004f8a:	557d                	li	a0,-1
    80004f8c:	b7ed                	j	80004f76 <sys_chdir+0x7a>
    iunlockput(ip);
    80004f8e:	8526                	mv	a0,s1
    80004f90:	ffffe097          	auipc	ra,0xffffe
    80004f94:	ea8080e7          	jalr	-344(ra) # 80002e38 <iunlockput>
    end_op();
    80004f98:	ffffe097          	auipc	ra,0xffffe
    80004f9c:	692080e7          	jalr	1682(ra) # 8000362a <end_op>
    return -1;
    80004fa0:	557d                	li	a0,-1
    80004fa2:	bfd1                	j	80004f76 <sys_chdir+0x7a>

0000000080004fa4 <sys_exec>:

uint64
sys_exec(void)
{
    80004fa4:	7145                	addi	sp,sp,-464
    80004fa6:	e786                	sd	ra,456(sp)
    80004fa8:	e3a2                	sd	s0,448(sp)
    80004faa:	ff26                	sd	s1,440(sp)
    80004fac:	fb4a                	sd	s2,432(sp)
    80004fae:	f74e                	sd	s3,424(sp)
    80004fb0:	f352                	sd	s4,416(sp)
    80004fb2:	ef56                	sd	s5,408(sp)
    80004fb4:	0b80                	addi	s0,sp,464
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80004fba:	f4040593          	addi	a1,s0,-192
    80004fbe:	4501                	li	a0,0
    80004fc0:	ffffd097          	auipc	ra,0xffffd
    80004fc4:	f78080e7          	jalr	-136(ra) # 80001f38 <argstr>
    return -1;
    80004fc8:	597d                	li	s2,-1
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    80004fca:	0c054a63          	bltz	a0,8000509e <sys_exec+0xfa>
    80004fce:	e3840593          	addi	a1,s0,-456
    80004fd2:	4505                	li	a0,1
    80004fd4:	ffffd097          	auipc	ra,0xffffd
    80004fd8:	f42080e7          	jalr	-190(ra) # 80001f16 <argaddr>
    80004fdc:	0c054163          	bltz	a0,8000509e <sys_exec+0xfa>
  }
  memset(argv, 0, sizeof(argv));
    80004fe0:	10000613          	li	a2,256
    80004fe4:	4581                	li	a1,0
    80004fe6:	e4040513          	addi	a0,s0,-448
    80004fea:	ffffb097          	auipc	ra,0xffffb
    80004fee:	18e080e7          	jalr	398(ra) # 80000178 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv)){
    80004ff2:	e4040493          	addi	s1,s0,-448
  memset(argv, 0, sizeof(argv));
    80004ff6:	89a6                	mv	s3,s1
    80004ff8:	4901                	li	s2,0
    if(i >= NELEM(argv)){
    80004ffa:	02000a13          	li	s4,32
    80004ffe:	00090a9b          	sext.w	s5,s2
      goto bad;
    }
    if(fetchaddr(uargv+sizeof(uint64)*i, (uint64*)&uarg) < 0){
    80005002:	00391513          	slli	a0,s2,0x3
    80005006:	e3040593          	addi	a1,s0,-464
    8000500a:	e3843783          	ld	a5,-456(s0)
    8000500e:	953e                	add	a0,a0,a5
    80005010:	ffffd097          	auipc	ra,0xffffd
    80005014:	e4a080e7          	jalr	-438(ra) # 80001e5a <fetchaddr>
    80005018:	02054a63          	bltz	a0,8000504c <sys_exec+0xa8>
      goto bad;
    }
    if(uarg == 0){
    8000501c:	e3043783          	ld	a5,-464(s0)
    80005020:	c3b9                	beqz	a5,80005066 <sys_exec+0xc2>
      argv[i] = 0;
      break;
    }
    argv[i] = kalloc();
    80005022:	ffffb097          	auipc	ra,0xffffb
    80005026:	0f6080e7          	jalr	246(ra) # 80000118 <kalloc>
    8000502a:	85aa                	mv	a1,a0
    8000502c:	00a9b023          	sd	a0,0(s3)
    if(argv[i] == 0)
    80005030:	cd11                	beqz	a0,8000504c <sys_exec+0xa8>
      goto bad;
    if(fetchstr(uarg, argv[i], PGSIZE) < 0)
    80005032:	6605                	lui	a2,0x1
    80005034:	e3043503          	ld	a0,-464(s0)
    80005038:	ffffd097          	auipc	ra,0xffffd
    8000503c:	e74080e7          	jalr	-396(ra) # 80001eac <fetchstr>
    80005040:	00054663          	bltz	a0,8000504c <sys_exec+0xa8>
    if(i >= NELEM(argv)){
    80005044:	0905                	addi	s2,s2,1
    80005046:	09a1                	addi	s3,s3,8
    80005048:	fb491be3          	bne	s2,s4,80004ffe <sys_exec+0x5a>
    kfree(argv[i]);
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    8000504c:	10048913          	addi	s2,s1,256
    80005050:	6088                	ld	a0,0(s1)
    80005052:	c529                	beqz	a0,8000509c <sys_exec+0xf8>
    kfree(argv[i]);
    80005054:	ffffb097          	auipc	ra,0xffffb
    80005058:	fc8080e7          	jalr	-56(ra) # 8000001c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    8000505c:	04a1                	addi	s1,s1,8
    8000505e:	ff2499e3          	bne	s1,s2,80005050 <sys_exec+0xac>
  return -1;
    80005062:	597d                	li	s2,-1
    80005064:	a82d                	j	8000509e <sys_exec+0xfa>
      argv[i] = 0;
    80005066:	0a8e                	slli	s5,s5,0x3
    80005068:	fc040793          	addi	a5,s0,-64
    8000506c:	9abe                	add	s5,s5,a5
    8000506e:	e80ab023          	sd	zero,-384(s5)
  int ret = exec(path, argv);
    80005072:	e4040593          	addi	a1,s0,-448
    80005076:	f4040513          	addi	a0,s0,-192
    8000507a:	fffff097          	auipc	ra,0xfffff
    8000507e:	05c080e7          	jalr	92(ra) # 800040d6 <exec>
    80005082:	892a                	mv	s2,a0
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005084:	10048993          	addi	s3,s1,256
    80005088:	6088                	ld	a0,0(s1)
    8000508a:	c911                	beqz	a0,8000509e <sys_exec+0xfa>
    kfree(argv[i]);
    8000508c:	ffffb097          	auipc	ra,0xffffb
    80005090:	f90080e7          	jalr	-112(ra) # 8000001c <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    80005094:	04a1                	addi	s1,s1,8
    80005096:	ff3499e3          	bne	s1,s3,80005088 <sys_exec+0xe4>
    8000509a:	a011                	j	8000509e <sys_exec+0xfa>
  return -1;
    8000509c:	597d                	li	s2,-1
}
    8000509e:	854a                	mv	a0,s2
    800050a0:	60be                	ld	ra,456(sp)
    800050a2:	641e                	ld	s0,448(sp)
    800050a4:	74fa                	ld	s1,440(sp)
    800050a6:	795a                	ld	s2,432(sp)
    800050a8:	79ba                	ld	s3,424(sp)
    800050aa:	7a1a                	ld	s4,416(sp)
    800050ac:	6afa                	ld	s5,408(sp)
    800050ae:	6179                	addi	sp,sp,464
    800050b0:	8082                	ret
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    800050c0:	d8c080e7          	jalr	-628(ra) # 80000e48 <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    800050d0:	e4a080e7          	jalr	-438(ra) # 80001f16 <argaddr>
    return -1;
  ...
  if(pipealloc(&rf, &wf) < 0)
    ...
    800050e6:	cc4080e7          	jalr	-828(ra) # 80003da6 <pipealloc>
    return -1;
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    ...
    800050fc:	3d0080e7          	jalr	976(ra) # 800044c8 <fdalloc>
    ...
    80005110:	3bc080e7          	jalr	956(ra) # 800044c8 <fdalloc>
    80005114:	fca42023          	sw	a0,-64(s0)
    80005118:	06054863          	bltz	a0,80005188 <sys_pipe+0xd6>
      p->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    8000512c:	9e2080e7          	jalr	-1566(ra) # 80000b0a <copyout>
    ...
    80005146:	9c8080e7          	jalr	-1592(ra) # 80000b0a <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    p->ofile[fd1] = 0;
    8000515e:	fc042503          	lw	a0,-64(s0)
    80005162:	0569                	addi	a0,a0,26
    ...
    80005186:	a805                	j	800051b6 <sys_pipe+0x104>
    if(fd0 >= 0)
    80005188:	fc442783          	lw	a5,-60(s0)
    8000518c:	0007c863          	bltz	a5,8000519c <sys_pipe+0xea>
      p->ofile[fd0] = 0;
    80005190:	01a78513          	addi	a0,a5,26
    ...
    800051a4:	8d6080e7          	jalr	-1834(ra) # 80003a76 <fileclose>
    fileclose(wf);
    800051a8:	fc843503          	ld	a0,-56(s0)
    800051ac:	fffff097          	auipc	ra,0xfffff
    800051b0:	8ca080e7          	jalr	-1846(ra) # 80003a76 <fileclose>
    return -1;
...
00000000800051c2 <sys_symlink>:

uint64 sys_symlink(void)
{
    800051c2:	712d                	addi	sp,sp,-288
    800051c4:	ee06                	sd	ra,280(sp)
    800051c6:	ea22                	sd	s0,272(sp)
    800051c8:	e626                	sd	s1,264(sp)
    800051ca:	1200                	addi	s0,sp,288
  char target[MAXPATH], path[MAXPATH];
  struct inode *ip;
  if(argstr(0, target, MAXPATH) < 0)
    800051cc:	08000613          	li	a2,128
    800051d0:	f6040593          	addi	a1,s0,-160
    800051d4:	4501                	li	a0,0
    800051d6:	ffffd097          	auipc	ra,0xffffd
    800051da:	d62080e7          	jalr	-670(ra) # 80001f38 <argstr>
    return -1;
    800051de:	57fd                	li	a5,-1
  if(argstr(0, target, MAXPATH) < 0)
    800051e0:	06054563          	bltz	a0,8000524a <sys_symlink+0x88>
  if(argstr(1, path, MAXPATH) < 0)
    800051e4:	08000613          	li	a2,128
    800051e8:	ee040593          	addi	a1,s0,-288
    800051ec:	4505                	li	a0,1
    800051ee:	ffffd097          	auipc	ra,0xffffd
    800051f2:	d4a080e7          	jalr	-694(ra) # 80001f38 <argstr>
    return -1;
    800051f6:	57fd                	li	a5,-1
  if(argstr(1, path, MAXPATH) < 0)
    800051f8:	04054963          	bltz	a0,8000524a <sys_symlink+0x88>

  begin_op();
    800051fc:	ffffe097          	auipc	ra,0xffffe
    80005200:	3ae080e7          	jalr	942(ra) # 800035aa <begin_op>
  if((ip = create(path, T_SYMLINK, 0, 0)) == 0)
    80005204:	4681                	li	a3,0
    80005206:	4601                	li	a2,0
    80005208:	4591                	li	a1,4
    8000520a:	ee040513          	addi	a0,s0,-288
    8000520e:	fffff097          	auipc	ra,0xfffff
    80005212:	2fc080e7          	jalr	764(ra) # 8000450a <create>
    80005216:	84aa                	mv	s1,a0
    80005218:	cd1d                	beqz	a0,80005256 <sys_symlink+0x94>
  {
    end_op();
    return -1;
  }
  ...
  if(writei(ip, 0, (uint64)target, 0, MAXPATH) < MAXPATH)
    8000521a:	08000713          	li	a4,128
    8000521e:	4681                	li	a3,0
    80005220:	f6040613          	addi	a2,s0,-160
    80005224:	4581                	li	a1,0
    80005226:	ffffe097          	auipc	ra,0xffffe
    8000522a:	d5c080e7          	jalr	-676(ra) # 80002f82 <writei>
    8000522e:	07f00793          	li	a5,127
    80005232:	02a7d863          	bge	a5,a0,80005262 <sys_symlink+0xa0>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  iunlockput(ip);
    ...
    8000523c:	c00080e7          	jalr	-1024(ra) # 80002e38 <iunlockput>
  end_op();
    80005240:	ffffe097          	auipc	ra,0xffffe
    80005244:	3ea080e7          	jalr	1002(ra) # 8000362a <end_op>
  return 0;
    80005248:	4781                	li	a5,0
    8000524a:	853e                	mv	a0,a5
    8000524c:	60f2                	ld	ra,280(sp)
    8000524e:	6452                	ld	s0,272(sp)
    80005250:	64b2                	ld	s1,264(sp)
    80005252:	6115                	addi	sp,sp,288
    80005254:	8082                	ret
    end_op();
    80005256:	ffffe097          	auipc	ra,0xffffe
    8000525a:	3d4080e7          	jalr	980(ra) # 8000362a <end_op>
    return -1;
    8000525e:	57fd                	li	a5,-1
    80005260:	b7ed                	j	8000524a <sys_symlink+0x88>
    iunlockput(ip);
    80005262:	8526                	mv	a0,s1
    80005264:	ffffe097          	auipc	ra,0xffffe
    80005268:	bd4080e7          	jalr	-1068(ra) # 80002e38 <iunlockput>
    end_op();
    8000526c:	ffffe097          	auipc	ra,0xffffe
    80005270:	3be080e7          	jalr	958(ra) # 8000362a <end_op>
    return -1;
    80005274:	57fd                	li	a5,-1
    80005276:	bfd1                	j	8000524a <sys_symlink+0x88>
	...
...
0000000080005280 <kernelvec>:
    ...
    800052c0:	a67fc0ef          	jal	ra,80001d26 <kerneltrap>
...
plicinithart(void)
{
  ...
  int hart = cpuid();
    ...
    8000535c:	ac4080e7          	jalr	-1340(ra) # 80000e1c <cpuid>
...
plic_claim(void)
{
  ...
  int hart = cpuid();
    ...
    80005394:	a8c080e7          	jalr	-1396(ra) # 80000e1c <cpuid>
...
plic_complete(int irq)
{
  ...
  int hart = cpuid();
    ...
    800053bc:	a64080e7          	jalr	-1436(ra) # 80000e1c <cpuid>
...
free_desc(int i)
{
  ...
  if(i >= NUM)
    ...
    800053e0:	06a7c963          	blt	a5,a0,80005452 <free_desc+0x7c>
    panic("free_desc 1");
  if(disk.free[i])
    800053e4:	00011797          	auipc	a5,0x11
    800053e8:	c1c78793          	addi	a5,a5,-996 # 80016000 <disk>
    800053ec:	00a78733          	add	a4,a5,a0
    800053f0:	6789                	lui	a5,0x2
    800053f2:	97ba                	add	a5,a5,a4
    800053f4:	0187c783          	lbu	a5,24(a5) # 2018 <_entry-0x7fffdfe8>
    800053f8:	e7ad                	bnez	a5,80005462 <free_desc+0x8c>
    panic("free_desc 2");
  disk.desc[i].addr = 0;
    800053fa:	00451793          	slli	a5,a0,0x4
    800053fe:	00013717          	auipc	a4,0x13
    80005402:	c0270713          	addi	a4,a4,-1022 # 80018000 <disk+0x2000>
    80005406:	6314                	ld	a3,0(a4)
    80005408:	96be                	add	a3,a3,a5
    8000540a:	0006b023          	sd	zero,0(a3)
  disk.desc[i].len = 0;
    8000540e:	6314                	ld	a3,0(a4)
    80005410:	96be                	add	a3,a3,a5
    80005412:	0006a423          	sw	zero,8(a3)
  disk.desc[i].flags = 0;
    80005416:	6314                	ld	a3,0(a4)
    80005418:	96be                	add	a3,a3,a5
    8000541a:	00069623          	sh	zero,12(a3)
  disk.desc[i].next = 0;
    8000541e:	6318                	ld	a4,0(a4)
    80005420:	97ba                	add	a5,a5,a4
    80005422:	00079723          	sh	zero,14(a5)
  disk.free[i] = 1;
    80005426:	00011797          	auipc	a5,0x11
    8000542a:	bda78793          	addi	a5,a5,-1062 # 80016000 <disk>
    8000542e:	97aa                	add	a5,a5,a0
    80005430:	6509                	lui	a0,0x2
    80005432:	953e                	add	a0,a0,a5
    80005434:	4785                	li	a5,1
    80005436:	00f50c23          	sb	a5,24(a0) # 2018 <_entry-0x7fffdfe8>
  wakeup(&disk.free[0]);
    8000543a:	00013517          	auipc	a0,0x13
    8000543e:	bde50513          	addi	a0,a0,-1058 # 80018018 <disk+0x2018>
    80005442:	ffffc097          	auipc	ra,0xffffc
    80005446:	24e080e7          	jalr	590(ra) # 80001690 <wakeup>
}
    8000544a:	60a2                	ld	ra,8(sp)
    8000544c:	6402                	ld	s0,0(sp)
    8000544e:	0141                	addi	sp,sp,16
    80005450:	8082                	ret
    panic("free_desc 1");
    80005452:	00003517          	auipc	a0,0x3
    80005456:	34e50513          	addi	a0,a0,846 # 800087a0 <syscalls+0x3d8>
    8000545a:	00001097          	auipc	ra,0x1
    8000545e:	a1e080e7          	jalr	-1506(ra) # 80005e78 <panic>
    panic("free_desc 2");
    80005462:	00003517          	auipc	a0,0x3
    80005466:	34e50513          	addi	a0,a0,846 # 800087b0 <syscalls+0x3e8>
    8000546a:	00001097          	auipc	ra,0x1
    8000546e:	a0e080e7          	jalr	-1522(ra) # 80005e78 <panic>

0000000080005472 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005480:	34458593          	addi	a1,a1,836 # 800087c0 <syscalls+0x3f8>
    80005484:	00013517          	auipc	a0,0x13
    80005488:	ca450513          	addi	a0,a0,-860 # 80018128 <disk+0x2128>
    8000548c:	00001097          	auipc	ra,0x1
    80005490:	ea6080e7          	jalr	-346(ra) # 80006332 <initlock>
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    80005494:	100017b7          	lui	a5,0x10001
    80005498:	4398                	lw	a4,0(a5)
    8000549a:	2701                	sext.w	a4,a4
    8000549c:	747277b7          	lui	a5,0x74727
    800054a0:	97678793          	addi	a5,a5,-1674 # 74726976 <_entry-0xb8d968a>
    800054a4:	0ef71163          	bne	a4,a5,80005586 <virtio_disk_init+0x114>
     *R(VIRTIO_MMIO_VERSION) != 1 ||
    800054a8:	100017b7          	lui	a5,0x10001
    800054ac:	43dc                	lw	a5,4(a5)
    800054ae:	2781                	sext.w	a5,a5
  if(*R(VIRTIO_MMIO_MAGIC_VALUE) != 0x74726976 ||
    800054b0:	4705                	li	a4,1
    800054b2:	0ce79a63          	bne	a5,a4,80005586 <virtio_disk_init+0x114>
     *R(VIRTIO_MMIO_DEVICE_ID) != 2 ||
    800054b6:	100017b7          	lui	a5,0x10001
    800054ba:	479c                	lw	a5,8(a5)
    800054bc:	2781                	sext.w	a5,a5
     *R(VIRTIO_MMIO_VERSION) != 1 ||
    800054be:	4709                	li	a4,2
    800054c0:	0ce79363          	bne	a5,a4,80005586 <virtio_disk_init+0x114>
     *R(VIRTIO_MMIO_VENDOR_ID) != 0x554d4551){
    800054c4:	100017b7          	lui	a5,0x10001
    800054c8:	47d8                	lw	a4,12(a5)
    800054ca:	2701                	sext.w	a4,a4
     *R(VIRTIO_MMIO_DEVICE_ID) != 2 ||
    800054cc:	554d47b7          	lui	a5,0x554d4
    800054d0:	55178793          	addi	a5,a5,1361 # 554d4551 <_entry-0x2ab2baaf>
    800054d4:	0af71963          	bne	a4,a5,80005586 <virtio_disk_init+0x114>
  *R(VIRTIO_MMIO_STATUS) = status;
    800054d8:	100017b7          	lui	a5,0x10001
    800054dc:	4705                	li	a4,1
    800054de:	dbb8                	sw	a4,112(a5)
  *R(VIRTIO_MMIO_STATUS) = status;
    800054e0:	470d                	li	a4,3
    800054e2:	dbb8                	sw	a4,112(a5)
  uint64 features = *R(VIRTIO_MMIO_DEVICE_FEATURES);
    800054e4:	4b94                	lw	a3,16(a5)
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    800054e6:	c7ffe737          	lui	a4,0xc7ffe
    800054ea:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdd51f>
    800054ee:	8f75                	and	a4,a4,a3
  *R(VIRTIO_MMIO_DRIVER_FEATURES) = features;
    800054f0:	2701                	sext.w	a4,a4
    800054f2:	d398                	sw	a4,32(a5)
  *R(VIRTIO_MMIO_STATUS) = status;
    800054f4:	472d                	li	a4,11
    800054f6:	dbb8                	sw	a4,112(a5)
  *R(VIRTIO_MMIO_STATUS) = status;
    800054f8:	473d                	li	a4,15
    800054fa:	dbb8                	sw	a4,112(a5)
  *R(VIRTIO_MMIO_GUEST_PAGE_SIZE) = PGSIZE;
    800054fc:	6705                	lui	a4,0x1
    800054fe:	d798                	sw	a4,40(a5)
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  if(max == 0)
    80005508:	c7d9                	beqz	a5,80005596 <virtio_disk_init+0x124>
  if(max < NUM)
    8000550a:	471d                	li	a4,7
    8000550c:	08f77d63          	bgeu	a4,a5,800055a6 <virtio_disk_init+0x134>
  *R(VIRTIO_MMIO_QUEUE_NUM) = NUM;
    80005510:	100014b7          	lui	s1,0x10001
    80005514:	47a1                	li	a5,8
    80005516:	dc9c                	sw	a5,56(s1)
  memset(disk.pages, 0, sizeof(disk.pages));
    80005518:	6609                	lui	a2,0x2
    8000551a:	4581                	li	a1,0
    8000551c:	00011517          	auipc	a0,0x11
    80005520:	ae450513          	addi	a0,a0,-1308 # 80016000 <disk>
    80005524:	ffffb097          	auipc	ra,0xffffb
    80005528:	c54080e7          	jalr	-940(ra) # 80000178 <memset>
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
    8000552c:	00011717          	auipc	a4,0x11
    80005530:	ad470713          	addi	a4,a4,-1324 # 80016000 <disk>
    80005534:	00c75793          	srli	a5,a4,0xc
    80005538:	2781                	sext.w	a5,a5
    8000553a:	c0bc                	sw	a5,64(s1)
  disk.desc = (struct virtq_desc *) disk.pages;
    8000553c:	00013797          	auipc	a5,0x13
    80005540:	ac478793          	addi	a5,a5,-1340 # 80018000 <disk+0x2000>
    80005544:	e398                	sd	a4,0(a5)
  disk.avail = (struct virtq_avail *)(disk.pages + NUM*sizeof(struct virtq_desc));
    80005546:	00011717          	auipc	a4,0x11
    8000554a:	b3a70713          	addi	a4,a4,-1222 # 80016080 <disk+0x80>
    8000554e:	e798                	sd	a4,8(a5)
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    80005550:	00012717          	auipc	a4,0x12
    80005554:	ab070713          	addi	a4,a4,-1360 # 80017000 <disk+0x1000>
    80005558:	eb98                	sd	a4,16(a5)
    disk.free[i] = 1;
    8000555a:	4705                	li	a4,1
    8000555c:	00e78c23          	sb	a4,24(a5)
    80005560:	00e78ca3          	sb	a4,25(a5)
    80005564:	00e78d23          	sb	a4,26(a5)
    80005568:	00e78da3          	sb	a4,27(a5)
    8000556c:	00e78e23          	sb	a4,28(a5)
    80005570:	00e78ea3          	sb	a4,29(a5)
    80005574:	00e78f23          	sb	a4,30(a5)
    80005578:	00e78fa3          	sb	a4,31(a5)
}
    ...
    8000558a:	24a50513          	addi	a0,a0,586 # 800087d0 <syscalls+0x408>
    8000558e:	00001097          	auipc	ra,0x1
    80005592:	8ea080e7          	jalr	-1814(ra) # 80005e78 <panic>
    panic("virtio disk has no queue 0");
    80005596:	00003517          	auipc	a0,0x3
    8000559a:	25a50513          	addi	a0,a0,602 # 800087f0 <syscalls+0x428>
    8000559e:	00001097          	auipc	ra,0x1
    800055a2:	8da080e7          	jalr	-1830(ra) # 80005e78 <panic>
    panic("virtio disk max queue too short");
    800055a6:	00003517          	auipc	a0,0x3
    800055aa:	26a50513          	addi	a0,a0,618 # 80008810 <syscalls+0x448>
    800055ae:	00001097          	auipc	ra,0x1
    800055b2:	8ca080e7          	jalr	-1846(ra) # 80005e78 <panic>

00000000800055b6 <virtio_disk_rw>:
  return 0;
}
...
{
    800055b6:	7159                	addi	sp,sp,-112
    800055b8:	f486                	sd	ra,104(sp)
    800055ba:	f0a2                	sd	s0,96(sp)
    800055bc:	eca6                	sd	s1,88(sp)
    800055be:	e8ca                	sd	s2,80(sp)
    800055c0:	e4ce                	sd	s3,72(sp)
    800055c2:	e0d2                	sd	s4,64(sp)
    800055c4:	fc56                	sd	s5,56(sp)
    800055c6:	f85a                	sd	s6,48(sp)
    800055c8:	f45e                	sd	s7,40(sp)
    800055ca:	f062                	sd	s8,32(sp)
    800055cc:	ec66                	sd	s9,24(sp)
    800055ce:	e86a                	sd	s10,16(sp)
    800055d0:	1880                	addi	s0,sp,112
    800055d2:	892a                	mv	s2,a0
    800055d4:	8d2e                	mv	s10,a1
  uint64 sector = b->blockno * (BSIZE / 512);
    800055d6:	00c52c83          	lw	s9,12(a0)
    800055da:	001c9c9b          	slliw	s9,s9,0x1
    800055de:	1c82                	slli	s9,s9,0x20
    800055e0:	020cdc93          	srli	s9,s9,0x20

  acquire(&disk.vdisk_lock);
    800055e4:	00013517          	auipc	a0,0x13
    800055e8:	b4450513          	addi	a0,a0,-1212 # 80018128 <disk+0x2128>
    800055ec:	00001097          	auipc	ra,0x1
    800055f0:	dd6080e7          	jalr	-554(ra) # 800063c2 <acquire>
  for(int i = 0; i < 3; i++){
    800055f4:	4981                	li	s3,0
  for(int i = 0; i < NUM; i++){
    800055f6:	4c21                	li	s8,8
      disk.free[i] = 0;
    800055f8:	00011b97          	auipc	s7,0x11
    800055fc:	a08b8b93          	addi	s7,s7,-1528 # 80016000 <disk>
    80005600:	6b09                	lui	s6,0x2
  for(int i = 0; i < 3; i++){
    80005602:	4a8d                	li	s5,3
  for(int i = 0; i < NUM; i++){
    80005604:	8a4e                	mv	s4,s3
    80005606:	a051                	j	8000568a <virtio_disk_rw+0xd4>
      disk.free[i] = 0;
    80005608:	00fb86b3          	add	a3,s7,a5
    8000560c:	96da                	add	a3,a3,s6
    8000560e:	00068c23          	sb	zero,24(a3)
    idx[i] = alloc_desc();
    80005612:	c21c                	sw	a5,0(a2)
    if(idx[i] < 0){
    80005614:	0207c563          	bltz	a5,8000563e <virtio_disk_rw+0x88>
  for(int i = 0; i < 3; i++){
    80005618:	2485                	addiw	s1,s1,1
    8000561a:	0711                	addi	a4,a4,4
    8000561c:	25548063          	beq	s1,s5,8000585c <virtio_disk_rw+0x2a6>
    idx[i] = alloc_desc();
    80005620:	863a                	mv	a2,a4
  for(int i = 0; i < NUM; i++){
    80005622:	00013697          	auipc	a3,0x13
    80005626:	9f668693          	addi	a3,a3,-1546 # 80018018 <disk+0x2018>
    8000562a:	87d2                	mv	a5,s4
    if(disk.free[i]){
    8000562c:	0006c583          	lbu	a1,0(a3)
    80005630:	fde1                	bnez	a1,80005608 <virtio_disk_rw+0x52>
  for(int i = 0; i < NUM; i++){
    80005632:	2785                	addiw	a5,a5,1
    80005634:	0685                	addi	a3,a3,1
    80005636:	ff879be3          	bne	a5,s8,8000562c <virtio_disk_rw+0x76>
    idx[i] = alloc_desc();
    8000563a:	57fd                	li	a5,-1
    8000563c:	c21c                	sw	a5,0(a2)
      for(int j = 0; j < i; j++)
    8000563e:	02905a63          	blez	s1,80005672 <virtio_disk_rw+0xbc>
        free_desc(idx[j]);
    80005642:	f9042503          	lw	a0,-112(s0)
    80005646:	00000097          	auipc	ra,0x0
    8000564a:	d90080e7          	jalr	-624(ra) # 800053d6 <free_desc>
      for(int j = 0; j < i; j++)
    8000564e:	4785                	li	a5,1
    80005650:	0297d163          	bge	a5,s1,80005672 <virtio_disk_rw+0xbc>
        free_desc(idx[j]);
    80005654:	f9442503          	lw	a0,-108(s0)
    80005658:	00000097          	auipc	ra,0x0
    8000565c:	d7e080e7          	jalr	-642(ra) # 800053d6 <free_desc>
      for(int j = 0; j < i; j++)
    80005660:	4789                	li	a5,2
    80005662:	0097d863          	bge	a5,s1,80005672 <virtio_disk_rw+0xbc>
        free_desc(idx[j]);
    80005666:	f9842503          	lw	a0,-104(s0)
    8000566a:	00000097          	auipc	ra,0x0
    8000566e:	d6c080e7          	jalr	-660(ra) # 800053d6 <free_desc>
  int idx[3];
  while(1){
    ...
    80005672:	00013597          	auipc	a1,0x13
    80005676:	ab658593          	addi	a1,a1,-1354 # 80018128 <disk+0x2128>
    8000567a:	00013517          	auipc	a0,0x13
    8000567e:	99e50513          	addi	a0,a0,-1634 # 80018018 <disk+0x2018>
    80005682:	ffffc097          	auipc	ra,0xffffc
    80005686:	e82080e7          	jalr	-382(ra) # 80001504 <sleep>
  for(int i = 0; i < 3; i++){
    8000568a:	f9040713          	addi	a4,s0,-112
    8000568e:	84ce                	mv	s1,s3
    80005690:	bf41                	j	80005620 <virtio_disk_rw+0x6a>
  ...
  if(write)
    ...
    80005692:	20058713          	addi	a4,a1,512
    80005696:	00471693          	slli	a3,a4,0x4
    8000569a:	00011717          	auipc	a4,0x11
    8000569e:	96670713          	addi	a4,a4,-1690 # 80016000 <disk>
    800056a2:	9736                	add	a4,a4,a3
    800056a4:	4685                	li	a3,1
    800056a6:	0ad72423          	sw	a3,168(a4)
  else
    buf0->type = VIRTIO_BLK_T_IN; // read the disk
  buf0->reserved = 0;
    800056aa:	20058713          	addi	a4,a1,512
    800056ae:	00471693          	slli	a3,a4,0x4
    800056b2:	00011717          	auipc	a4,0x11
    800056b6:	94e70713          	addi	a4,a4,-1714 # 80016000 <disk>
    800056ba:	9736                	add	a4,a4,a3
    800056bc:	0a072623          	sw	zero,172(a4)
  buf0->sector = sector;
    800056c0:	0b973823          	sd	s9,176(a4)

  disk.desc[idx[0]].addr = (uint64) buf0;
    800056c4:	7679                	lui	a2,0xffffe
    800056c6:	963e                	add	a2,a2,a5
    800056c8:	00013697          	auipc	a3,0x13
    800056cc:	93868693          	addi	a3,a3,-1736 # 80018000 <disk+0x2000>
    800056d0:	6298                	ld	a4,0(a3)
    800056d2:	9732                	add	a4,a4,a2
    800056d4:	e308                	sd	a0,0(a4)
  disk.desc[idx[0]].len = sizeof(struct virtio_blk_req);
    800056d6:	6298                	ld	a4,0(a3)
    800056d8:	9732                	add	a4,a4,a2
    800056da:	4541                	li	a0,16
    800056dc:	c708                	sw	a0,8(a4)
  disk.desc[idx[0]].flags = VRING_DESC_F_NEXT;
    800056de:	6298                	ld	a4,0(a3)
    800056e0:	9732                	add	a4,a4,a2
    800056e2:	4505                	li	a0,1
    800056e4:	00a71623          	sh	a0,12(a4)
  disk.desc[idx[0]].next = idx[1];
    800056e8:	f9442703          	lw	a4,-108(s0)
    800056ec:	6288                	ld	a0,0(a3)
    800056ee:	962a                	add	a2,a2,a0
    800056f0:	00e61723          	sh	a4,14(a2) # ffffffffffffe00e <end+0xffffffff7ffdcdce>

  disk.desc[idx[1]].addr = (uint64) b->data;
    800056f4:	0712                	slli	a4,a4,0x4
    800056f6:	6290                	ld	a2,0(a3)
    800056f8:	963a                	add	a2,a2,a4
    800056fa:	05890513          	addi	a0,s2,88
    800056fe:	e208                	sd	a0,0(a2)
  disk.desc[idx[1]].len = BSIZE;
    80005700:	6294                	ld	a3,0(a3)
    80005702:	96ba                	add	a3,a3,a4
    80005704:	40000613          	li	a2,1024
    80005708:	c690                	sw	a2,8(a3)
  if(write)
    8000570a:	140d0063          	beqz	s10,8000584a <virtio_disk_rw+0x294>
    disk.desc[idx[1]].flags = 0; // device reads b->data
    8000570e:	00013697          	auipc	a3,0x13
    80005712:	8f26b683          	ld	a3,-1806(a3) # 80018000 <disk+0x2000>
    80005716:	96ba                	add	a3,a3,a4
    80005718:	00069623          	sh	zero,12(a3)
  else
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
  disk.desc[idx[1]].flags |= VRING_DESC_F_NEXT;
    8000571c:	00011817          	auipc	a6,0x11
    80005720:	8e480813          	addi	a6,a6,-1820 # 80016000 <disk>
    80005724:	00013517          	auipc	a0,0x13
    80005728:	8dc50513          	addi	a0,a0,-1828 # 80018000 <disk+0x2000>
    8000572c:	6114                	ld	a3,0(a0)
    8000572e:	96ba                	add	a3,a3,a4
    80005730:	00c6d603          	lhu	a2,12(a3)
    80005734:	00166613          	ori	a2,a2,1
    80005738:	00c69623          	sh	a2,12(a3)
  disk.desc[idx[1]].next = idx[2];
    8000573c:	f9842683          	lw	a3,-104(s0)
    80005740:	6110                	ld	a2,0(a0)
    80005742:	9732                	add	a4,a4,a2
    80005744:	00d71723          	sh	a3,14(a4)

  disk.info[idx[0]].status = 0xff; // device writes 0 on success
    80005748:	20058613          	addi	a2,a1,512
    8000574c:	0612                	slli	a2,a2,0x4
    8000574e:	9642                	add	a2,a2,a6
    80005750:	577d                	li	a4,-1
    80005752:	02e60823          	sb	a4,48(a2)
  disk.desc[idx[2]].addr = (uint64) &disk.info[idx[0]].status;
    80005756:	00469713          	slli	a4,a3,0x4
    8000575a:	6114                	ld	a3,0(a0)
    8000575c:	96ba                	add	a3,a3,a4
    8000575e:	03078793          	addi	a5,a5,48
    80005762:	97c2                	add	a5,a5,a6
    80005764:	e29c                	sd	a5,0(a3)
  disk.desc[idx[2]].len = 1;
    80005766:	611c                	ld	a5,0(a0)
    80005768:	97ba                	add	a5,a5,a4
    8000576a:	4685                	li	a3,1
    8000576c:	c794                	sw	a3,8(a5)
  disk.desc[idx[2]].flags = VRING_DESC_F_WRITE; // device writes the status
    8000576e:	611c                	ld	a5,0(a0)
    80005770:	97ba                	add	a5,a5,a4
    80005772:	4809                	li	a6,2
    80005774:	01079623          	sh	a6,12(a5)
  disk.desc[idx[2]].next = 0;
    80005778:	611c                	ld	a5,0(a0)
    8000577a:	973e                	add	a4,a4,a5
    8000577c:	00071723          	sh	zero,14(a4)

  // record struct buf for virtio_disk_intr().
  b->disk = 1;
    80005780:	00d92223          	sw	a3,4(s2)
  disk.info[idx[0]].b = b;
    80005784:	03263423          	sd	s2,40(a2)

  // tell the device the first index in our chain of descriptors.
  disk.avail->ring[disk.avail->idx % NUM] = idx[0];
    80005788:	6518                	ld	a4,8(a0)
    8000578a:	00275783          	lhu	a5,2(a4)
    8000578e:	8b9d                	andi	a5,a5,7
    80005790:	0786                	slli	a5,a5,0x1
    80005792:	97ba                	add	a5,a5,a4
    80005794:	00b79223          	sh	a1,4(a5)
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
    ...
    800057b0:	0407a823          	sw	zero,80(a5) # 10001050 <_entry-0x6fffefb0>

  // Wait for virtio_disk_intr() to say request has finished.
  while(b->disk == 1) {
    800057b4:	00492703          	lw	a4,4(s2)
    800057b8:	4785                	li	a5,1
    800057ba:	02f71163          	bne	a4,a5,800057dc <virtio_disk_rw+0x226>
    sleep(b, &disk.vdisk_lock);
    800057be:	00013997          	auipc	s3,0x13
    800057c2:	96a98993          	addi	s3,s3,-1686 # 80018128 <disk+0x2128>
  while(b->disk == 1) {
    ...
    800057d0:	d38080e7          	jalr	-712(ra) # 80001504 <sleep>
  while(b->disk == 1) {
    800057d4:	00492783          	lw	a5,4(s2)
    800057d8:	fe9788e3          	beq	a5,s1,800057c8 <virtio_disk_rw+0x212>
  }

  disk.info[idx[0]].b = 0;
    800057dc:	f9042903          	lw	s2,-112(s0)
    800057e0:	20090793          	addi	a5,s2,512
    800057e4:	00479713          	slli	a4,a5,0x4
    800057e8:	00011797          	auipc	a5,0x11
    800057ec:	81878793          	addi	a5,a5,-2024 # 80016000 <disk>
    800057f0:	97ba                	add	a5,a5,a4
    800057f2:	0207b423          	sd	zero,40(a5)
    int flag = disk.desc[i].flags;
    800057f6:	00013997          	auipc	s3,0x13
    800057fa:	80a98993          	addi	s3,s3,-2038 # 80018000 <disk+0x2000>
    800057fe:	00491713          	slli	a4,s2,0x4
    80005802:	0009b783          	ld	a5,0(s3)
    80005806:	97ba                	add	a5,a5,a4
    80005808:	00c7d483          	lhu	s1,12(a5)
    int nxt = disk.desc[i].next;
    8000580c:	854a                	mv	a0,s2
    8000580e:	00e7d903          	lhu	s2,14(a5)
    free_desc(i);
    80005812:	00000097          	auipc	ra,0x0
    80005816:	bc4080e7          	jalr	-1084(ra) # 800053d6 <free_desc>
    if(flag & VRING_DESC_F_NEXT)
    8000581a:	8885                	andi	s1,s1,1
    8000581c:	f0ed                	bnez	s1,800057fe <virtio_disk_rw+0x248>
  free_chain(idx[0]);

  release(&disk.vdisk_lock);
    8000581e:	00013517          	auipc	a0,0x13
    80005822:	90a50513          	addi	a0,a0,-1782 # 80018128 <disk+0x2128>
    80005826:	00001097          	auipc	ra,0x1
    8000582a:	c50080e7          	jalr	-944(ra) # 80006476 <release>
}
    8000582e:	70a6                	ld	ra,104(sp)
    80005830:	7406                	ld	s0,96(sp)
    80005832:	64e6                	ld	s1,88(sp)
    80005834:	6946                	ld	s2,80(sp)
    80005836:	69a6                	ld	s3,72(sp)
    80005838:	6a06                	ld	s4,64(sp)
    8000583a:	7ae2                	ld	s5,56(sp)
    8000583c:	7b42                	ld	s6,48(sp)
    8000583e:	7ba2                	ld	s7,40(sp)
    80005840:	7c02                	ld	s8,32(sp)
    80005842:	6ce2                	ld	s9,24(sp)
    80005844:	6d42                	ld	s10,16(sp)
    80005846:	6165                	addi	sp,sp,112
    80005848:	8082                	ret
    disk.desc[idx[1]].flags = VRING_DESC_F_WRITE; // device writes b->data
    8000584a:	00012697          	auipc	a3,0x12
    8000584e:	7b66b683          	ld	a3,1974(a3) # 80018000 <disk+0x2000>
    80005852:	96ba                	add	a3,a3,a4
    80005854:	4609                	li	a2,2
    80005856:	00c69623          	sh	a2,12(a3)
    8000585a:	b5c9                	j	8000571c <virtio_disk_rw+0x166>
  struct virtio_blk_req *buf0 = &disk.ops[idx[0]];
    8000585c:	f9042583          	lw	a1,-112(s0)
    80005860:	20058793          	addi	a5,a1,512
    80005864:	0792                	slli	a5,a5,0x4
    80005866:	00011517          	auipc	a0,0x11
    8000586a:	84250513          	addi	a0,a0,-1982 # 800160a8 <disk+0xa8>
    8000586e:	953e                	add	a0,a0,a5
  if(write)
    80005870:	e20d11e3          	bnez	s10,80005692 <virtio_disk_rw+0xdc>
    buf0->type = VIRTIO_BLK_T_IN; // read the disk
    80005874:	20058713          	addi	a4,a1,512
    80005878:	00471693          	slli	a3,a4,0x4
    8000587c:	00010717          	auipc	a4,0x10
    80005880:	78470713          	addi	a4,a4,1924 # 80016000 <disk>
    80005884:	9736                	add	a4,a4,a3
    80005886:	0a072423          	sw	zero,168(a4)
    8000588a:	b505                	j	800056aa <virtio_disk_rw+0xf4>
...
virtio_disk_intr()
{
    ...
    80005894:	e04a                	sd	s2,0(sp)
    80005896:	1000                	addi	s0,sp,32
  acquire(&disk.vdisk_lock);
    80005898:	00013517          	auipc	a0,0x13
    8000589c:	89050513          	addi	a0,a0,-1904 # 80018128 <disk+0x2128>
    800058a0:	00001097          	auipc	ra,0x1
    800058a4:	b22080e7          	jalr	-1246(ra) # 800063c2 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
    ...
    800058ac:	533c                	lw	a5,96(a4)
    800058ae:	8b8d                	andi	a5,a5,3
    800058b0:	d37c                	sw	a5,100(a4)
  ...
  while(disk.used_idx != disk.used->idx){
    800058b6:	00012797          	auipc	a5,0x12
    800058ba:	74a78793          	addi	a5,a5,1866 # 80018000 <disk+0x2000>
    800058be:	6b94                	ld	a3,16(a5)
    800058c0:	0207d703          	lhu	a4,32(a5)
    800058c4:	0026d783          	lhu	a5,2(a3)
    800058c8:	06f70163          	beq	a4,a5,8000592a <virtio_disk_intr+0x9e>
    __sync_synchronize();
    int id = disk.used->ring[disk.used_idx % NUM].id;
    800058cc:	00010917          	auipc	s2,0x10
    800058d0:	73490913          	addi	s2,s2,1844 # 80016000 <disk>
    800058d4:	00012497          	auipc	s1,0x12
    800058d8:	72c48493          	addi	s1,s1,1836 # 80018000 <disk+0x2000>
    __sync_synchronize();
    800058dc:	0ff0000f          	fence
    int id = disk.used->ring[disk.used_idx % NUM].id;
    800058e0:	6898                	ld	a4,16(s1)
    800058e2:	0204d783          	lhu	a5,32(s1)
    800058e6:	8b9d                	andi	a5,a5,7
    800058e8:	078e                	slli	a5,a5,0x3
    800058ea:	97ba                	add	a5,a5,a4
    800058ec:	43dc                	lw	a5,4(a5)

    if(disk.info[id].status != 0)
    800058ee:	20078713          	addi	a4,a5,512
    800058f2:	0712                	slli	a4,a4,0x4
    800058f4:	974a                	add	a4,a4,s2
    800058f6:	03074703          	lbu	a4,48(a4) # 10001030 <_entry-0x6fffefd0>
    800058fa:	e731                	bnez	a4,80005946 <virtio_disk_intr+0xba>
      panic("virtio_disk_intr status");

    struct buf *b = disk.info[id].b;
    800058fc:	20078793          	addi	a5,a5,512
    80005900:	0792                	slli	a5,a5,0x4
    80005902:	97ca                	add	a5,a5,s2
    80005904:	7788                	ld	a0,40(a5)
    b->disk = 0;   // disk is done with buf
    80005906:	00052223          	sw	zero,4(a0)
    wakeup(b);
    8000590a:	ffffc097          	auipc	ra,0xffffc
    8000590e:	d86080e7          	jalr	-634(ra) # 80001690 <wakeup>

    disk.used_idx += 1;
    80005912:	0204d783          	lhu	a5,32(s1)
    80005916:	2785                	addiw	a5,a5,1
    80005918:	17c2                	slli	a5,a5,0x30
    8000591a:	93c1                	srli	a5,a5,0x30
    8000591c:	02f49023          	sh	a5,32(s1)
  while(disk.used_idx != disk.used->idx){
    80005920:	6898                	ld	a4,16(s1)
    80005922:	00275703          	lhu	a4,2(a4)
    80005926:	faf71be3          	bne	a4,a5,800058dc <virtio_disk_intr+0x50>
  }

  release(&disk.vdisk_lock);
    8000592a:	00012517          	auipc	a0,0x12
    8000592e:	7fe50513          	addi	a0,a0,2046 # 80018128 <disk+0x2128>
    80005932:	00001097          	auipc	ra,0x1
    80005936:	b44080e7          	jalr	-1212(ra) # 80006476 <release>
}
    8000593a:	60e2                	ld	ra,24(sp)
    8000593c:	6442                	ld	s0,16(sp)
    8000593e:	64a2                	ld	s1,8(sp)
    80005940:	6902                	ld	s2,0(sp)
    80005942:	6105                	addi	sp,sp,32
    80005944:	8082                	ret
      panic("virtio_disk_intr status");
    80005946:	00003517          	auipc	a0,0x3
    8000594a:	eea50513          	addi	a0,a0,-278 # 80008830 <syscalls+0x468>
    8000594e:	00000097          	auipc	ra,0x0
    80005952:	52a080e7          	jalr	1322(ra) # 80005e78 <panic>

0000000080005956 <timerinit>:
...
timerinit()
{
    ...
    80005958:	e422                	sd	s0,8(sp)
    8000595a:	0800                	addi	s0,sp,16
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    8000595c:	f14027f3          	csrr	a5,mhartid
  // each CPU has a separate source of timer interrupts.
  int id = r_mhartid();
    80005960:	0007869b          	sext.w	a3,a5

  // ask the CLINT for a timer interrupt.
  int interval = 1000000; // cycles; about 1/10th second in qemu.
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    80005964:	0037979b          	slliw	a5,a5,0x3
    80005968:	02004737          	lui	a4,0x2004
    8000596c:	97ba                	add	a5,a5,a4
    8000596e:	0200c737          	lui	a4,0x200c
    80005972:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    80005976:	000f4637          	lui	a2,0xf4
    8000597a:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    8000597e:	95b2                	add	a1,a1,a2
    80005980:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    80005982:	00269713          	slli	a4,a3,0x2
    80005986:	9736                	add	a4,a4,a3
    80005988:	00371693          	slli	a3,a4,0x3
    8000598c:	00013717          	auipc	a4,0x13
    80005990:	67470713          	addi	a4,a4,1652 # 80019000 <timer_scratch>
    80005994:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    80005996:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    80005998:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    8000599a:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    8000599e:	00000797          	auipc	a5,0x0
    800059a2:	97278793          	addi	a5,a5,-1678 # 80005310 <timervec>
    800059a6:	30579073          	csrw	mtvec,a5
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    800059aa:	300027f3          	csrr	a5,mstatus
  ...
  w_mstatus(r_mstatus() | MSTATUS_MIE);
    800059ae:	0087e793          	ori	a5,a5,8
  asm volatile("csrw mstatus, %0" : : "r" (x));
    800059b2:	30079073          	csrw	mstatus,a5
  asm volatile("csrr %0, mie" : "=r" (x) );
    800059b6:	304027f3          	csrr	a5,mie

  // enable machine-mode timer interrupts.
  w_mie(r_mie() | MIE_MTIE);
    800059ba:	0807e793          	ori	a5,a5,128
  asm volatile("csrw mie, %0" : : "r" (x));
    800059be:	30479073          	csrw	mie,a5
}
...
00000000800059c8 <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    800059d4:	7779                	lui	a4,0xffffe
    800059d6:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdd5bf>
    800059da:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    800059dc:	6705                	lui	a4,0x1
    800059de:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    800059e2:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    800059e4:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    800059e8:	ffffb797          	auipc	a5,0xffffb
    800059ec:	93e78793          	addi	a5,a5,-1730 # 80000326 <main>
    800059f0:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    800059f4:	4781                	li	a5,0
    800059f6:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    800059fa:	67c1                	lui	a5,0x10
    800059fc:	17fd                	addi	a5,a5,-1
    800059fe:	30279073          	csrw	medeleg,a5
  asm volatile("csrw mideleg, %0" : : "r" (x));
    80005a02:	30379073          	csrw	mideleg,a5
  asm volatile("csrr %0, sie" : "=r" (x) );
    80005a06:	104027f3          	csrr	a5,sie
  w_sie(r_sie() | SIE_SEIE | SIE_STIE | SIE_SSIE);
    80005a0a:	2227e793          	ori	a5,a5,546
  asm volatile("csrw sie, %0" : : "r" (x));
    80005a0e:	10479073          	csrw	sie,a5
  asm volatile("csrw pmpaddr0, %0" : : "r" (x));
    80005a12:	57fd                	li	a5,-1
    80005a14:	83a9                	srli	a5,a5,0xa
    80005a16:	3b079073          	csrw	pmpaddr0,a5
  asm volatile("csrw pmpcfg0, %0" : : "r" (x));
    80005a1a:	47bd                	li	a5,15
    80005a1c:	3a079073          	csrw	pmpcfg0,a5
  timerinit();
    80005a20:	00000097          	auipc	ra,0x0
    80005a24:	f36080e7          	jalr	-202(ra) # 80005956 <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    80005a28:	f14027f3          	csrr	a5,mhartid
  w_tp(id);
    80005a2c:	2781                	sext.w	a5,a5
  asm volatile("mv tp, %0" : : "r" (x));
    80005a2e:	823e                	mv	tp,a5
  asm volatile("mret");
    80005a30:	30200073          	mret
}
...
consolewrite(int user_src, uint64 src, int n)
{
  ...
  for(i = 0; i < n; i++){
    80005a4e:	04c05663          	blez	a2,80005a9a <consolewrite+0x5e>
    80005a52:	8a2a                	mv	s4,a0
    80005a54:	84ae                	mv	s1,a1
    80005a56:	89b2                	mv	s3,a2
    80005a58:	4901                	li	s2,0
    char c;
    if(either_copyin(&c, user_src, src+i, 1) == -1)
    80005a5a:	5afd                	li	s5,-1
    80005a5c:	4685                	li	a3,1
    80005a5e:	8626                	mv	a2,s1
    80005a60:	85d2                	mv	a1,s4
    80005a62:	fbf40513          	addi	a0,s0,-65
    80005a66:	ffffc097          	auipc	ra,0xffffc
    80005a6a:	e98080e7          	jalr	-360(ra) # 800018fe <either_copyin>
    80005a6e:	01550c63          	beq	a0,s5,80005a86 <consolewrite+0x4a>
      break;
    uartputc(c);
    80005a72:	fbf44503          	lbu	a0,-65(s0)
    80005a76:	00000097          	auipc	ra,0x0
    80005a7a:	78e080e7          	jalr	1934(ra) # 80006204 <uartputc>
  for(i = 0; i < n; i++){
    80005a7e:	2905                	addiw	s2,s2,1
    80005a80:	0485                	addi	s1,s1,1
    80005a82:	fd299de3          	bne	s3,s2,80005a5c <consolewrite+0x20>
  }
  ...
  return i;
    ...
    80005a8e:	7942                	ld	s2,48(sp)
    80005a90:	79a2                	ld	s3,40(sp)
    80005a92:	7a02                	ld	s4,32(sp)
    80005a94:	6ae2                	ld	s5,24(sp)
    80005a96:	6161                	addi	sp,sp,80
    80005a98:	8082                	ret
  for(i = 0; i < n; i++){
    80005a9a:	4901                	li	s2,0
    80005a9c:	b7ed                	j	80005a86 <consolewrite+0x4a>

0000000080005a9e <consoleread>:
...
{
    80005a9e:	7119                	addi	sp,sp,-128
    80005aa0:	fc86                	sd	ra,120(sp)
    80005aa2:	f8a2                	sd	s0,112(sp)
    80005aa4:	f4a6                	sd	s1,104(sp)
    80005aa6:	f0ca                	sd	s2,96(sp)
    80005aa8:	ecce                	sd	s3,88(sp)
    80005aaa:	e8d2                	sd	s4,80(sp)
    80005aac:	e4d6                	sd	s5,72(sp)
    80005aae:	e0da                	sd	s6,64(sp)
    80005ab0:	fc5e                	sd	s7,56(sp)
    80005ab2:	f862                	sd	s8,48(sp)
    80005ab4:	f466                	sd	s9,40(sp)
    80005ab6:	f06a                	sd	s10,32(sp)
    80005ab8:	ec6e                	sd	s11,24(sp)
    80005aba:	0100                	addi	s0,sp,128
    80005abc:	8b2a                	mv	s6,a0
  ...
  target = n;
    80005ac2:	00060b9b          	sext.w	s7,a2
  acquire(&cons.lock);
    80005ac6:	0001b517          	auipc	a0,0x1b
    80005aca:	67a50513          	addi	a0,a0,1658 # 80021140 <cons>
    80005ace:	00001097          	auipc	ra,0x1
    80005ad2:	8f4080e7          	jalr	-1804(ra) # 800063c2 <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    80005ad6:	0001b497          	auipc	s1,0x1b
    80005ada:	66a48493          	addi	s1,s1,1642 # 80021140 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
    ...
    80005ae0:	0001b917          	auipc	s2,0x1b
    80005ae4:	6f890913          	addi	s2,s2,1784 # 800211d8 <cons+0x98>
    }

    c = cons.buf[cons.r++ % INPUT_BUF];

    if(c == C('D')){  // end-of-file
    80005ae8:	4c91                	li	s9,4
      break;
    }
    ...
    if(c == '\n'){
    80005aec:	4da9                	li	s11,10
  while(n > 0){
    80005aee:	07405863          	blez	s4,80005b5e <consoleread+0xc0>
    while(cons.r == cons.w){
    80005af2:	0984a783          	lw	a5,152(s1)
    80005af6:	09c4a703          	lw	a4,156(s1)
    80005afa:	02f71463          	bne	a4,a5,80005b22 <consoleread+0x84>
      if(myproc()->killed){
    80005afe:	ffffb097          	auipc	ra,0xffffb
    80005b02:	34a080e7          	jalr	842(ra) # 80000e48 <myproc>
    80005b06:	551c                	lw	a5,40(a0)
    80005b08:	e7b5                	bnez	a5,80005b74 <consoleread+0xd6>
      sleep(&cons.r, &cons.lock);
    80005b0a:	85ce                	mv	a1,s3
    80005b0c:	854a                	mv	a0,s2
    80005b0e:	ffffc097          	auipc	ra,0xffffc
    80005b12:	9f6080e7          	jalr	-1546(ra) # 80001504 <sleep>
    while(cons.r == cons.w){
    80005b16:	0984a783          	lw	a5,152(s1)
    80005b1a:	09c4a703          	lw	a4,156(s1)
    80005b1e:	fef700e3          	beq	a4,a5,80005afe <consoleread+0x60>
    c = cons.buf[cons.r++ % INPUT_BUF];
    80005b22:	0017871b          	addiw	a4,a5,1
    80005b26:	08e4ac23          	sw	a4,152(s1)
    80005b2a:	07f7f713          	andi	a4,a5,127
    80005b2e:	9726                	add	a4,a4,s1
    80005b30:	01874703          	lbu	a4,24(a4)
    80005b34:	00070c1b          	sext.w	s8,a4
    if(c == C('D')){  // end-of-file
    80005b38:	079c0663          	beq	s8,s9,80005ba4 <consoleread+0x106>
    cbuf = c;
    80005b3c:	f8e407a3          	sb	a4,-113(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    80005b40:	4685                	li	a3,1
    80005b42:	f8f40613          	addi	a2,s0,-113
    80005b46:	85d6                	mv	a1,s5
    80005b48:	855a                	mv	a0,s6
    80005b4a:	ffffc097          	auipc	ra,0xffffc
    80005b4e:	d5e080e7          	jalr	-674(ra) # 800018a8 <either_copyout>
    80005b52:	01a50663          	beq	a0,s10,80005b5e <consoleread+0xc0>
    dst++;
    80005b56:	0a85                	addi	s5,s5,1
    --n;
    80005b58:	3a7d                	addiw	s4,s4,-1
    if(c == '\n'){
    80005b5a:	f9bc1ae3          	bne	s8,s11,80005aee <consoleread+0x50>
  ...
  release(&cons.lock);
    80005b5e:	0001b517          	auipc	a0,0x1b
    80005b62:	5e250513          	addi	a0,a0,1506 # 80021140 <cons>
    80005b66:	00001097          	auipc	ra,0x1
    80005b6a:	910080e7          	jalr	-1776(ra) # 80006476 <release>

  return target - n;
    80005b6e:	414b853b          	subw	a0,s7,s4
    80005b72:	a811                	j	80005b86 <consoleread+0xe8>
        release(&cons.lock);
    80005b74:	0001b517          	auipc	a0,0x1b
    80005b78:	5cc50513          	addi	a0,a0,1484 # 80021140 <cons>
    80005b7c:	00001097          	auipc	ra,0x1
    80005b80:	8fa080e7          	jalr	-1798(ra) # 80006476 <release>
        return -1;
    80005b84:	557d                	li	a0,-1
}
    80005b86:	70e6                	ld	ra,120(sp)
    80005b88:	7446                	ld	s0,112(sp)
    80005b8a:	74a6                	ld	s1,104(sp)
    80005b8c:	7906                	ld	s2,96(sp)
    80005b8e:	69e6                	ld	s3,88(sp)
    80005b90:	6a46                	ld	s4,80(sp)
    80005b92:	6aa6                	ld	s5,72(sp)
    80005b94:	6b06                	ld	s6,64(sp)
    80005b96:	7be2                	ld	s7,56(sp)
    80005b98:	7c42                	ld	s8,48(sp)
    80005b9a:	7ca2                	ld	s9,40(sp)
    80005b9c:	7d02                	ld	s10,32(sp)
    80005b9e:	6de2                	ld	s11,24(sp)
    80005ba0:	6109                	addi	sp,sp,128
    80005ba2:	8082                	ret
      if(n < target){
    80005ba4:	000a071b          	sext.w	a4,s4
    80005ba8:	fb777be3          	bgeu	a4,s7,80005b5e <consoleread+0xc0>
        cons.r--;
    80005bac:	0001b717          	auipc	a4,0x1b
    80005bb0:	62f72623          	sw	a5,1580(a4) # 800211d8 <cons+0x98>
    80005bb4:	b76d                	j	80005b5e <consoleread+0xc0>

0000000080005bb6 <consputc>:
{
  ...
  if(c == BACKSPACE){
    80005bbe:	10000793          	li	a5,256
    80005bc2:	00f50a63          	beq	a0,a5,80005bd6 <consputc+0x20>
    uartputc_sync(c);
    80005bc6:	00000097          	auipc	ra,0x0
    80005bca:	564080e7          	jalr	1380(ra) # 8000612a <uartputc_sync>
}
    ...
    80005bd6:	4521                	li	a0,8
    80005bd8:	00000097          	auipc	ra,0x0
    80005bdc:	552080e7          	jalr	1362(ra) # 8000612a <uartputc_sync>
    80005be0:	02000513          	li	a0,32
    80005be4:	00000097          	auipc	ra,0x0
    80005be8:	546080e7          	jalr	1350(ra) # 8000612a <uartputc_sync>
    80005bec:	4521                	li	a0,8
    80005bee:	00000097          	auipc	ra,0x0
    80005bf2:	53c080e7          	jalr	1340(ra) # 8000612a <uartputc_sync>
    80005bf6:	bfe1                	j	80005bce <consputc+0x18>

0000000080005bf8 <consoleintr>:
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    80005c0a:	53a50513          	addi	a0,a0,1338 # 80021140 <cons>
    80005c0e:	00000097          	auipc	ra,0x0
    80005c12:	7b4080e7          	jalr	1972(ra) # 800063c2 <acquire>

  switch(c){
    80005c16:	47d5                	li	a5,21
    80005c18:	0af48663          	beq	s1,a5,80005cc4 <consoleintr+0xcc>
    80005c1c:	0297ca63          	blt	a5,s1,80005c50 <consoleintr+0x58>
    80005c20:	47a1                	li	a5,8
    80005c22:	0ef48763          	beq	s1,a5,80005d10 <consoleintr+0x118>
    80005c26:	47c1                	li	a5,16
    80005c28:	10f49a63          	bne	s1,a5,80005d3c <consoleintr+0x144>
  case C('P'):  // Print process list.
    procdump();
    80005c2c:	ffffc097          	auipc	ra,0xffffc
    80005c30:	d28080e7          	jalr	-728(ra) # 80001954 <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    80005c34:	0001b517          	auipc	a0,0x1b
    80005c38:	50c50513          	addi	a0,a0,1292 # 80021140 <cons>
    80005c3c:	00001097          	auipc	ra,0x1
    80005c40:	83a080e7          	jalr	-1990(ra) # 80006476 <release>
}
    80005c44:	60e2                	ld	ra,24(sp)
    80005c46:	6442                	ld	s0,16(sp)
    80005c48:	64a2                	ld	s1,8(sp)
    80005c4a:	6902                	ld	s2,0(sp)
    80005c4c:	6105                	addi	sp,sp,32
    80005c4e:	8082                	ret
  switch(c){
    80005c50:	07f00793          	li	a5,127
    80005c54:	0af48e63          	beq	s1,a5,80005d10 <consoleintr+0x118>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80005c58:	0001b717          	auipc	a4,0x1b
    80005c5c:	4e870713          	addi	a4,a4,1256 # 80021140 <cons>
    80005c60:	0a072783          	lw	a5,160(a4)
    80005c64:	09872703          	lw	a4,152(a4)
    80005c68:	9f99                	subw	a5,a5,a4
    80005c6a:	07f00713          	li	a4,127
    80005c6e:	fcf763e3          	bltu	a4,a5,80005c34 <consoleintr+0x3c>
      c = (c == '\r') ? '\n' : c;
    80005c72:	47b5                	li	a5,13
    80005c74:	0cf48763          	beq	s1,a5,80005d42 <consoleintr+0x14a>
      consputc(c);
    80005c78:	8526                	mv	a0,s1
    80005c7a:	00000097          	auipc	ra,0x0
    80005c7e:	f3c080e7          	jalr	-196(ra) # 80005bb6 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80005c82:	0001b797          	auipc	a5,0x1b
    80005c86:	4be78793          	addi	a5,a5,1214 # 80021140 <cons>
    80005c8a:	0a07a703          	lw	a4,160(a5)
    80005c8e:	0017069b          	addiw	a3,a4,1
    80005c92:	0006861b          	sext.w	a2,a3
    80005c96:	0ad7a023          	sw	a3,160(a5)
    80005c9a:	07f77713          	andi	a4,a4,127
    80005c9e:	97ba                	add	a5,a5,a4
    80005ca0:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e == cons.r+INPUT_BUF){
    80005ca4:	47a9                	li	a5,10
    80005ca6:	0cf48563          	beq	s1,a5,80005d70 <consoleintr+0x178>
    80005caa:	4791                	li	a5,4
    80005cac:	0cf48263          	beq	s1,a5,80005d70 <consoleintr+0x178>
    80005cb0:	0001b797          	auipc	a5,0x1b
    80005cb4:	5287a783          	lw	a5,1320(a5) # 800211d8 <cons+0x98>
    80005cb8:	0807879b          	addiw	a5,a5,128
    80005cbc:	f6f61ce3          	bne	a2,a5,80005c34 <consoleintr+0x3c>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80005cc0:	863e                	mv	a2,a5
    80005cc2:	a07d                	j	80005d70 <consoleintr+0x178>
    while(cons.e != cons.w &&
    80005cc4:	0001b717          	auipc	a4,0x1b
    80005cc8:	47c70713          	addi	a4,a4,1148 # 80021140 <cons>
    80005ccc:	0a072783          	lw	a5,160(a4)
    80005cd0:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80005cd4:	0001b497          	auipc	s1,0x1b
    80005cd8:	46c48493          	addi	s1,s1,1132 # 80021140 <cons>
    while(cons.e != cons.w &&
    80005cdc:	4929                	li	s2,10
    80005cde:	f4f70be3          	beq	a4,a5,80005c34 <consoleintr+0x3c>
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    ...
    80005cee:	f52703e3          	beq	a4,s2,80005c34 <consoleintr+0x3c>
      cons.e--;
    80005cf2:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    80005cf6:	10000513          	li	a0,256
    80005cfa:	00000097          	auipc	ra,0x0
    80005cfe:	ebc080e7          	jalr	-324(ra) # 80005bb6 <consputc>
    while(cons.e != cons.w &&
    80005d02:	0a04a783          	lw	a5,160(s1)
    80005d06:	09c4a703          	lw	a4,156(s1)
    80005d0a:	fcf71ce3          	bne	a4,a5,80005ce2 <consoleintr+0xea>
    80005d0e:	b71d                	j	80005c34 <consoleintr+0x3c>
    if(cons.e != cons.w){
    80005d10:	0001b717          	auipc	a4,0x1b
    80005d14:	43070713          	addi	a4,a4,1072 # 80021140 <cons>
    80005d18:	0a072783          	lw	a5,160(a4)
    80005d1c:	09c72703          	lw	a4,156(a4)
    80005d20:	f0f70ae3          	beq	a4,a5,80005c34 <consoleintr+0x3c>
      cons.e--;
    80005d24:	37fd                	addiw	a5,a5,-1
    80005d26:	0001b717          	auipc	a4,0x1b
    80005d2a:	4af72d23          	sw	a5,1210(a4) # 800211e0 <cons+0xa0>
      consputc(BACKSPACE);
    80005d2e:	10000513          	li	a0,256
    80005d32:	00000097          	auipc	ra,0x0
    80005d36:	e84080e7          	jalr	-380(ra) # 80005bb6 <consputc>
    80005d3a:	bded                	j	80005c34 <consoleintr+0x3c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80005d3c:	ee048ce3          	beqz	s1,80005c34 <consoleintr+0x3c>
    80005d40:	bf21                	j	80005c58 <consoleintr+0x60>
      consputc(c);
    80005d42:	4529                	li	a0,10
    80005d44:	00000097          	auipc	ra,0x0
    80005d48:	e72080e7          	jalr	-398(ra) # 80005bb6 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80005d4c:	0001b797          	auipc	a5,0x1b
    80005d50:	3f478793          	addi	a5,a5,1012 # 80021140 <cons>
    80005d54:	0a07a703          	lw	a4,160(a5)
    80005d58:	0017069b          	addiw	a3,a4,1
    80005d5c:	0006861b          	sext.w	a2,a3
    80005d60:	0ad7a023          	sw	a3,160(a5)
    80005d64:	07f77713          	andi	a4,a4,127
    80005d68:	97ba                	add	a5,a5,a4
    80005d6a:	4729                	li	a4,10
    80005d6c:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80005d70:	0001b797          	auipc	a5,0x1b
    80005d74:	46c7a623          	sw	a2,1132(a5) # 800211dc <cons+0x9c>
        wakeup(&cons.r);
    80005d78:	0001b517          	auipc	a0,0x1b
    80005d7c:	46050513          	addi	a0,a0,1120 # 800211d8 <cons+0x98>
    80005d80:	ffffc097          	auipc	ra,0xffffc
    80005d84:	910080e7          	jalr	-1776(ra) # 80001690 <wakeup>
    80005d88:	b575                	j	80005c34 <consoleintr+0x3c>

0000000080005d8a <consoleinit>:
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005d96:	ab658593          	addi	a1,a1,-1354 # 80008848 <syscalls+0x480>
    80005d9a:	0001b517          	auipc	a0,0x1b
    80005d9e:	3a650513          	addi	a0,a0,934 # 80021140 <cons>
    80005da2:	00000097          	auipc	ra,0x0
    80005da6:	590080e7          	jalr	1424(ra) # 80006332 <initlock>

  uartinit();
    80005daa:	00000097          	auipc	ra,0x0
    80005dae:	330080e7          	jalr	816(ra) # 800060da <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80005db2:	0000f797          	auipc	a5,0xf
    80005db6:	8b678793          	addi	a5,a5,-1866 # 80014668 <devsw>
    80005dba:	00000717          	auipc	a4,0x0
    80005dbe:	ce470713          	addi	a4,a4,-796 # 80005a9e <consoleread>
    80005dc2:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80005dc4:	00000717          	auipc	a4,0x0
    80005dc8:	c7870713          	addi	a4,a4,-904 # 80005a3c <consolewrite>
    80005dcc:	ef98                	sd	a4,24(a5)
}
...
printint(int xx, int base, int sign)
{
  ...
  if(sign && (sign = xx < 0))
    80005de2:	c219                	beqz	a2,80005de8 <printint+0x12>
    80005de4:	08054663          	bltz	a0,80005e70 <printint+0x9a>
    x = -xx;
  else
    x = xx;
    80005de8:	2501                	sext.w	a0,a0
    80005dea:	4881                	li	a7,0
    80005dec:	fd040693          	addi	a3,s0,-48

  i = 0;
    80005df0:	4701                	li	a4,0
  do {
    buf[i++] = digits[x % base];
    80005df2:	2581                	sext.w	a1,a1
    80005df4:	00003617          	auipc	a2,0x3
    80005df8:	a8460613          	addi	a2,a2,-1404 # 80008878 <digits>
    80005dfc:	883a                	mv	a6,a4
    80005dfe:	2705                	addiw	a4,a4,1
    80005e00:	02b577bb          	remuw	a5,a0,a1
    80005e04:	1782                	slli	a5,a5,0x20
    80005e06:	9381                	srli	a5,a5,0x20
    80005e08:	97b2                	add	a5,a5,a2
    80005e0a:	0007c783          	lbu	a5,0(a5)
    80005e0e:	00f68023          	sb	a5,0(a3)
  } while((x /= base) != 0);
    80005e12:	0005079b          	sext.w	a5,a0
    80005e16:	02b5553b          	divuw	a0,a0,a1
    80005e1a:	0685                	addi	a3,a3,1
    80005e1c:	feb7f0e3          	bgeu	a5,a1,80005dfc <printint+0x26>

  if(sign)
    80005e20:	00088b63          	beqz	a7,80005e36 <printint+0x60>
    buf[i++] = '-';
    80005e24:	fe040793          	addi	a5,s0,-32
    80005e28:	973e                	add	a4,a4,a5
    80005e2a:	02d00793          	li	a5,45
    80005e2e:	fef70823          	sb	a5,-16(a4)
    80005e32:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80005e36:	02e05763          	blez	a4,80005e64 <printint+0x8e>
    80005e3a:	fd040793          	addi	a5,s0,-48
    80005e3e:	00e784b3          	add	s1,a5,a4
    80005e42:	fff78913          	addi	s2,a5,-1
    80005e46:	993a                	add	s2,s2,a4
    80005e48:	377d                	addiw	a4,a4,-1
    80005e4a:	1702                	slli	a4,a4,0x20
    80005e4c:	9301                	srli	a4,a4,0x20
    80005e4e:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80005e52:	fff4c503          	lbu	a0,-1(s1)
    80005e56:	00000097          	auipc	ra,0x0
    80005e5a:	d60080e7          	jalr	-672(ra) # 80005bb6 <consputc>
  while(--i >= 0)
    80005e5e:	14fd                	addi	s1,s1,-1
    80005e60:	ff2499e3          	bne	s1,s2,80005e52 <printint+0x7c>
}
    80005e64:	70a2                	ld	ra,40(sp)
    80005e66:	7402                	ld	s0,32(sp)
    80005e68:	64e2                	ld	s1,24(sp)
    80005e6a:	6942                	ld	s2,16(sp)
    80005e6c:	6145                	addi	sp,sp,48
    80005e6e:	8082                	ret
    x = -xx;
    80005e70:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80005e74:	4885                	li	a7,1
    x = -xx;
    80005e76:	bf9d                	j	80005dec <printint+0x16>

0000000080005e78 <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
  ...
  pr.locking = 0;
    80005e84:	0001b797          	auipc	a5,0x1b
    80005e88:	3607ae23          	sw	zero,892(a5) # 80021200 <pr+0x18>
  printf("panic: ");
    80005e8c:	00003517          	auipc	a0,0x3
    80005e90:	9c450513          	addi	a0,a0,-1596 # 80008850 <syscalls+0x488>
    80005e94:	00000097          	auipc	ra,0x0
    80005e98:	02e080e7          	jalr	46(ra) # 80005ec2 <printf>
  printf(s);
    80005e9c:	8526                	mv	a0,s1
    80005e9e:	00000097          	auipc	ra,0x0
    80005ea2:	024080e7          	jalr	36(ra) # 80005ec2 <printf>
  printf("\n");
    80005ea6:	00003517          	auipc	a0,0x3
    80005eaa:	8ba50513          	addi	a0,a0,-1862 # 80008760 <syscalls+0x398>
    80005eae:	00000097          	auipc	ra,0x0
    80005eb2:	014080e7          	jalr	20(ra) # 80005ec2 <printf>
  panicked = 1; // freeze uart output from other CPUs
    80005eb6:	4785                	li	a5,1
    80005eb8:	00003717          	auipc	a4,0x3
    80005ebc:	16f72223          	sw	a5,356(a4) # 8000901c <panicked>
  for(;;)
    80005ec0:	a001                	j	80005ec0 <panic+0x48>

0000000080005ec2 <printf>:
{
    80005ec2:	7131                	addi	sp,sp,-192
    80005ec4:	fc86                	sd	ra,120(sp)
    80005ec6:	f8a2                	sd	s0,112(sp)
    80005ec8:	f4a6                	sd	s1,104(sp)
    80005eca:	f0ca                	sd	s2,96(sp)
    80005ecc:	ecce                	sd	s3,88(sp)
    80005ece:	e8d2                	sd	s4,80(sp)
    80005ed0:	e4d6                	sd	s5,72(sp)
    80005ed2:	e0da                	sd	s6,64(sp)
    80005ed4:	fc5e                	sd	s7,56(sp)
    80005ed6:	f862                	sd	s8,48(sp)
    80005ed8:	f466                	sd	s9,40(sp)
    80005eda:	f06a                	sd	s10,32(sp)
    80005edc:	ec6e                	sd	s11,24(sp)
    80005ede:	0100                	addi	s0,sp,128
    80005ee0:	8a2a                	mv	s4,a0
    80005ee2:	e40c                	sd	a1,8(s0)
    80005ee4:	e810                	sd	a2,16(s0)
    80005ee6:	ec14                	sd	a3,24(s0)
    80005ee8:	f018                	sd	a4,32(s0)
    80005eea:	f41c                	sd	a5,40(s0)
    80005eec:	03043823          	sd	a6,48(s0)
    80005ef0:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80005ef4:	0001bd97          	auipc	s11,0x1b
    80005ef8:	30cdad83          	lw	s11,780(s11) # 80021200 <pr+0x18>
  if(locking)
    80005efc:	020d9b63          	bnez	s11,80005f32 <printf+0x70>
  if (fmt == 0)
    80005f00:	040a0263          	beqz	s4,80005f44 <printf+0x82>
  va_start(ap, fmt);
    80005f04:	00840793          	addi	a5,s0,8
    80005f08:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80005f0c:	000a4503          	lbu	a0,0(s4)
    80005f10:	16050263          	beqz	a0,80006074 <printf+0x1b2>
    80005f14:	4481                	li	s1,0
    if(c != '%'){
    80005f16:	02500a93          	li	s5,37
    switch(c){
    80005f1a:	07000b13          	li	s6,112
  consputc('x');
    80005f1e:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80005f20:	00003b97          	auipc	s7,0x3
    80005f24:	958b8b93          	addi	s7,s7,-1704 # 80008878 <digits>
    switch(c){
    80005f28:	07300c93          	li	s9,115
    80005f2c:	06400c13          	li	s8,100
    80005f30:	a82d                	j	80005f6a <printf+0xa8>
    acquire(&pr.lock);
    80005f32:	0001b517          	auipc	a0,0x1b
    80005f36:	2b650513          	addi	a0,a0,694 # 800211e8 <pr>
    80005f3a:	00000097          	auipc	ra,0x0
    80005f3e:	488080e7          	jalr	1160(ra) # 800063c2 <acquire>
    80005f42:	bf7d                	j	80005f00 <printf+0x3e>
    panic("null fmt");
    80005f44:	00003517          	auipc	a0,0x3
    80005f48:	91c50513          	addi	a0,a0,-1764 # 80008860 <syscalls+0x498>
    80005f4c:	00000097          	auipc	ra,0x0
    80005f50:	f2c080e7          	jalr	-212(ra) # 80005e78 <panic>
      consputc(c);
    80005f54:	00000097          	auipc	ra,0x0
    80005f58:	c62080e7          	jalr	-926(ra) # 80005bb6 <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80005f5c:	2485                	addiw	s1,s1,1
    80005f5e:	009a07b3          	add	a5,s4,s1
    80005f62:	0007c503          	lbu	a0,0(a5)
    80005f66:	10050763          	beqz	a0,80006074 <printf+0x1b2>
    if(c != '%'){
    80005f6a:	ff5515e3          	bne	a0,s5,80005f54 <printf+0x92>
    c = fmt[++i] & 0xff;
    80005f6e:	2485                	addiw	s1,s1,1
    80005f70:	009a07b3          	add	a5,s4,s1
    80005f74:	0007c783          	lbu	a5,0(a5)
    80005f78:	0007891b          	sext.w	s2,a5
    if(c == 0)
    80005f7c:	cfe5                	beqz	a5,80006074 <printf+0x1b2>
    switch(c){
    80005f7e:	05678a63          	beq	a5,s6,80005fd2 <printf+0x110>
    80005f82:	02fb7663          	bgeu	s6,a5,80005fae <printf+0xec>
    80005f86:	09978963          	beq	a5,s9,80006018 <printf+0x156>
    80005f8a:	07800713          	li	a4,120
    80005f8e:	0ce79863          	bne	a5,a4,8000605e <printf+0x19c>
      printint(va_arg(ap, int), 16, 1);
    80005f92:	f8843783          	ld	a5,-120(s0)
    80005f96:	00878713          	addi	a4,a5,8
    80005f9a:	f8e43423          	sd	a4,-120(s0)
    80005f9e:	4605                	li	a2,1
    80005fa0:	85ea                	mv	a1,s10
    80005fa2:	4388                	lw	a0,0(a5)
    80005fa4:	00000097          	auipc	ra,0x0
    80005fa8:	e32080e7          	jalr	-462(ra) # 80005dd6 <printint>
      break;
    80005fac:	bf45                	j	80005f5c <printf+0x9a>
    switch(c){
    80005fae:	0b578263          	beq	a5,s5,80006052 <printf+0x190>
    80005fb2:	0b879663          	bne	a5,s8,8000605e <printf+0x19c>
      printint(va_arg(ap, int), 10, 1);
    80005fb6:	f8843783          	ld	a5,-120(s0)
    80005fba:	00878713          	addi	a4,a5,8
    80005fbe:	f8e43423          	sd	a4,-120(s0)
    80005fc2:	4605                	li	a2,1
    80005fc4:	45a9                	li	a1,10
    80005fc6:	4388                	lw	a0,0(a5)
    80005fc8:	00000097          	auipc	ra,0x0
    80005fcc:	e0e080e7          	jalr	-498(ra) # 80005dd6 <printint>
      break;
    80005fd0:	b771                	j	80005f5c <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80005fd2:	f8843783          	ld	a5,-120(s0)
    80005fd6:	00878713          	addi	a4,a5,8
    80005fda:	f8e43423          	sd	a4,-120(s0)
    80005fde:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80005fe2:	03000513          	li	a0,48
    80005fe6:	00000097          	auipc	ra,0x0
    80005fea:	bd0080e7          	jalr	-1072(ra) # 80005bb6 <consputc>
  consputc('x');
    80005fee:	07800513          	li	a0,120
    80005ff2:	00000097          	auipc	ra,0x0
    80005ff6:	bc4080e7          	jalr	-1084(ra) # 80005bb6 <consputc>
    80005ffa:	896a                	mv	s2,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80005ffc:	03c9d793          	srli	a5,s3,0x3c
    80006000:	97de                	add	a5,a5,s7
    80006002:	0007c503          	lbu	a0,0(a5)
    80006006:	00000097          	auipc	ra,0x0
    8000600a:	bb0080e7          	jalr	-1104(ra) # 80005bb6 <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    8000600e:	0992                	slli	s3,s3,0x4
    80006010:	397d                	addiw	s2,s2,-1
    80006012:	fe0915e3          	bnez	s2,80005ffc <printf+0x13a>
    80006016:	b799                	j	80005f5c <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80006018:	f8843783          	ld	a5,-120(s0)
    8000601c:	00878713          	addi	a4,a5,8
    80006020:	f8e43423          	sd	a4,-120(s0)
    80006024:	0007b903          	ld	s2,0(a5)
    80006028:	00090e63          	beqz	s2,80006044 <printf+0x182>
      for(; *s; s++)
    8000602c:	00094503          	lbu	a0,0(s2)
    80006030:	d515                	beqz	a0,80005f5c <printf+0x9a>
        consputc(*s);
    80006032:	00000097          	auipc	ra,0x0
    80006036:	b84080e7          	jalr	-1148(ra) # 80005bb6 <consputc>
      for(; *s; s++)
    8000603a:	0905                	addi	s2,s2,1
    8000603c:	00094503          	lbu	a0,0(s2)
    80006040:	f96d                	bnez	a0,80006032 <printf+0x170>
    80006042:	bf29                	j	80005f5c <printf+0x9a>
        s = "(null)";
    80006044:	00003917          	auipc	s2,0x3
    80006048:	81490913          	addi	s2,s2,-2028 # 80008858 <syscalls+0x490>
      for(; *s; s++)
    8000604c:	02800513          	li	a0,40
    80006050:	b7cd                	j	80006032 <printf+0x170>
      consputc('%');
    80006052:	8556                	mv	a0,s5
    80006054:	00000097          	auipc	ra,0x0
    80006058:	b62080e7          	jalr	-1182(ra) # 80005bb6 <consputc>
      break;
    8000605c:	b701                	j	80005f5c <printf+0x9a>
      consputc('%');
    8000605e:	8556                	mv	a0,s5
    80006060:	00000097          	auipc	ra,0x0
    80006064:	b56080e7          	jalr	-1194(ra) # 80005bb6 <consputc>
      consputc(c);
    80006068:	854a                	mv	a0,s2
    8000606a:	00000097          	auipc	ra,0x0
    8000606e:	b4c080e7          	jalr	-1204(ra) # 80005bb6 <consputc>
      break;
    80006072:	b5ed                	j	80005f5c <printf+0x9a>
  if(locking)
    80006074:	020d9163          	bnez	s11,80006096 <printf+0x1d4>
}
    ...
    80006094:	8082                	ret
    release(&pr.lock);
    80006096:	0001b517          	auipc	a0,0x1b
    8000609a:	15250513          	addi	a0,a0,338 # 800211e8 <pr>
    8000609e:	00000097          	auipc	ra,0x0
    800060a2:	3d8080e7          	jalr	984(ra) # 80006476 <release>
}
    800060a6:	bfc9                	j	80006078 <printf+0x1b6>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    800060b2:	0001b497          	auipc	s1,0x1b
    800060b6:	13648493          	addi	s1,s1,310 # 800211e8 <pr>
    800060ba:	00002597          	auipc	a1,0x2
    800060be:	7b658593          	addi	a1,a1,1974 # 80008870 <syscalls+0x4a8>
    800060c2:	8526                	mv	a0,s1
    800060c4:	00000097          	auipc	ra,0x0
    800060c8:	26e080e7          	jalr	622(ra) # 80006332 <initlock>
  pr.locking = 1;
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    8000610e:	78658593          	addi	a1,a1,1926 # 80008890 <digits+0x18>
    80006112:	0001b517          	auipc	a0,0x1b
    80006116:	0f650513          	addi	a0,a0,246 # 80021208 <uart_tx_lock>
    8000611a:	00000097          	auipc	ra,0x0
    8000611e:	218080e7          	jalr	536(ra) # 80006332 <initlock>
}
...
uartputc_sync(int c)
{
  ...
  push_off();
    ...
    8000613a:	240080e7          	jalr	576(ra) # 80006376 <push_off>

  if(panicked){
    8000613e:	00003797          	auipc	a5,0x3
    80006142:	ede7a783          	lw	a5,-290(a5) # 8000901c <panicked>
    for(;;)
      ;
  }
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    ...
    80006152:	0ff7f793          	andi	a5,a5,255
    80006156:	0207f793          	andi	a5,a5,32
    8000615a:	dbf5                	beqz	a5,8000614e <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    8000615c:	0ff4f793          	andi	a5,s1,255
    80006160:	10000737          	lui	a4,0x10000
    80006164:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80006168:	00000097          	auipc	ra,0x0
    8000616c:	2ae080e7          	jalr	686(ra) # 80006416 <pop_off>
}
...
uartstart()
{
  while(1){
    ...
    8000618a:	06e78c63          	beq	a5,a4,80006202 <uartstart+0x88>
{
    8000618e:	7139                	addi	sp,sp,-64
    80006190:	fc06                	sd	ra,56(sp)
    80006192:	f822                	sd	s0,48(sp)
    80006194:	f426                	sd	s1,40(sp)
    80006196:	f04a                	sd	s2,32(sp)
    80006198:	ec4e                	sd	s3,24(sp)
    8000619a:	e852                	sd	s4,16(sp)
    8000619c:	e456                	sd	s5,8(sp)
    8000619e:	0080                	addi	s0,sp,64
      // transmit buffer is empty.
      return;
    }
    
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    800061a0:	10000937          	lui	s2,0x10000
    ...
    800061a4:	0001ba17          	auipc	s4,0x1b
    800061a8:	064a0a13          	addi	s4,s4,100 # 80021208 <uart_tx_lock>
    uart_tx_r += 1;
    800061ac:	00003497          	auipc	s1,0x3
    800061b0:	e7448493          	addi	s1,s1,-396 # 80009020 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    800061b4:	00003997          	auipc	s3,0x3
    800061b8:	e7498993          	addi	s3,s3,-396 # 80009028 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    800061bc:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    800061c0:	0ff7f793          	andi	a5,a5,255
    800061c4:	0207f793          	andi	a5,a5,32
    800061c8:	c785                	beqz	a5,800061f0 <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    800061ca:	01f77793          	andi	a5,a4,31
    800061ce:	97d2                	add	a5,a5,s4
    800061d0:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    800061d4:	0705                	addi	a4,a4,1
    800061d6:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    800061d8:	8526                	mv	a0,s1
    800061da:	ffffb097          	auipc	ra,0xffffb
    800061de:	4b6080e7          	jalr	1206(ra) # 80001690 <wakeup>
    
    WriteReg(THR, c);
    800061e2:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    800061e6:	6098                	ld	a4,0(s1)
    800061e8:	0009b783          	ld	a5,0(s3)
    800061ec:	fce798e3          	bne	a5,a4,800061bc <uartstart+0x42>
  }
}
    ...
    800061fe:	6121                	addi	sp,sp,64
    80006200:	8082                	ret
    80006202:	8082                	ret

0000000080006204 <uartputc>:
{
    80006204:	7179                	addi	sp,sp,-48
    ...
    80006212:	1800                	addi	s0,sp,48
    80006214:	89aa                	mv	s3,a0
  acquire(&uart_tx_lock);
    80006216:	0001b517          	auipc	a0,0x1b
    8000621a:	ff250513          	addi	a0,a0,-14 # 80021208 <uart_tx_lock>
    8000621e:	00000097          	auipc	ra,0x0
    80006222:	1a4080e7          	jalr	420(ra) # 800063c2 <acquire>
  if(panicked){
    80006226:	00003797          	auipc	a5,0x3
    8000622a:	df67a783          	lw	a5,-522(a5) # 8000901c <panicked>
    8000622e:	c391                	beqz	a5,80006232 <uartputc+0x2e>
    for(;;)
    80006230:	a001                	j	80006230 <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006232:	00003797          	auipc	a5,0x3
    80006236:	df67b783          	ld	a5,-522(a5) # 80009028 <uart_tx_w>
    8000623a:	00003717          	auipc	a4,0x3
    8000623e:	de673703          	ld	a4,-538(a4) # 80009020 <uart_tx_r>
    80006242:	02070713          	addi	a4,a4,32
    80006246:	02f71b63          	bne	a4,a5,8000627c <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    8000624a:	0001ba17          	auipc	s4,0x1b
    8000624e:	fbea0a13          	addi	s4,s4,-66 # 80021208 <uart_tx_lock>
    80006252:	00003497          	auipc	s1,0x3
    80006256:	dce48493          	addi	s1,s1,-562 # 80009020 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000625a:	00003917          	auipc	s2,0x3
    8000625e:	dce90913          	addi	s2,s2,-562 # 80009028 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006262:	85d2                	mv	a1,s4
    80006264:	8526                	mv	a0,s1
    80006266:	ffffb097          	auipc	ra,0xffffb
    8000626a:	29e080e7          	jalr	670(ra) # 80001504 <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000626e:	00093783          	ld	a5,0(s2)
    80006272:	6098                	ld	a4,0(s1)
    80006274:	02070713          	addi	a4,a4,32
    80006278:	fef705e3          	beq	a4,a5,80006262 <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    8000627c:	0001b497          	auipc	s1,0x1b
    80006280:	f8c48493          	addi	s1,s1,-116 # 80021208 <uart_tx_lock>
    80006284:	01f7f713          	andi	a4,a5,31
    80006288:	9726                	add	a4,a4,s1
    8000628a:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    8000628e:	0785                	addi	a5,a5,1
    80006290:	00003717          	auipc	a4,0x3
    80006294:	d8f73c23          	sd	a5,-616(a4) # 80009028 <uart_tx_w>
      uartstart();
    80006298:	00000097          	auipc	ra,0x0
    8000629c:	ee2080e7          	jalr	-286(ra) # 8000617a <uartstart>
      release(&uart_tx_lock);
    800062a0:	8526                	mv	a0,s1
    800062a2:	00000097          	auipc	ra,0x0
    800062a6:	1d4080e7          	jalr	468(ra) # 80006476 <release>
}
...
uartgetc(void)
{
  ...
  if(ReadReg(LSR) & 0x01){
    ...
    800062c8:	8b85                	andi	a5,a5,1
    800062ca:	cb91                	beqz	a5,800062de <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    800062cc:	100007b7          	lui	a5,0x10000
    800062d0:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
    800062d4:	0ff57513          	andi	a0,a0,255
  } else {
    return -1;
  }
}
    ...
    800062e0:	bfe5                	j	800062d8 <uartgetc+0x1e>

00000000800062e2 <uartintr>:
...
uartintr(void)
{
  ...
  while(1){
    int c = uartgetc();
    if(c == -1)
    800062ec:	54fd                	li	s1,-1
    int c = uartgetc();
    800062ee:	00000097          	auipc	ra,0x0
    800062f2:	fcc080e7          	jalr	-52(ra) # 800062ba <uartgetc>
    if(c == -1)
    800062f6:	00950763          	beq	a0,s1,80006304 <uartintr+0x22>
      break;
    consoleintr(c);
    800062fa:	00000097          	auipc	ra,0x0
    800062fe:	8fe080e7          	jalr	-1794(ra) # 80005bf8 <consoleintr>
  while(1){
    80006302:	b7f5                	j	800062ee <uartintr+0xc>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    80006304:	0001b497          	auipc	s1,0x1b
    80006308:	f0448493          	addi	s1,s1,-252 # 80021208 <uart_tx_lock>
    8000630c:	8526                	mv	a0,s1
    8000630e:	00000097          	auipc	ra,0x0
    80006312:	0b4080e7          	jalr	180(ra) # 800063c2 <acquire>
  uartstart();
    80006316:	00000097          	auipc	ra,0x0
    8000631a:	e64080e7          	jalr	-412(ra) # 8000617a <uartstart>
  release(&uart_tx_lock);
    8000631e:	8526                	mv	a0,s1
    80006320:	00000097          	auipc	ra,0x0
    80006324:	156080e7          	jalr	342(ra) # 80006476 <release>
}
...
initlock(struct spinlock *lk, char *name)
{
    ...
    80006334:	e422                	sd	s0,8(sp)
    80006336:	0800                	addi	s0,sp,16
  lk->name = name;
    80006338:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    8000633a:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    8000633e:	00053823          	sd	zero,16(a0)
}
    80006342:	6422                	ld	s0,8(sp)
    80006344:	0141                	addi	sp,sp,16
    80006346:	8082                	ret

0000000080006348 <holding>:
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    80006348:	411c                	lw	a5,0(a0)
    8000634a:	e399                	bnez	a5,80006350 <holding+0x8>
    ...
    8000634e:	8082                	ret
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    8000635a:	6904                	ld	s1,16(a0)
    8000635c:	ffffb097          	auipc	ra,0xffffb
    80006360:	ad0080e7          	jalr	-1328(ra) # 80000e2c <mycpu>
    80006364:	40a48533          	sub	a0,s1,a0
    80006368:	00153513          	seqz	a0,a0
}
...
push_off(void)
{
  ...
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80006380:	100024f3          	csrr	s1,sstatus
    80006384:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    80006388:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
  ...
  if(mycpu()->noff == 0)
    ...
    80006392:	a9e080e7          	jalr	-1378(ra) # 80000e2c <mycpu>
    80006396:	5d3c                	lw	a5,120(a0)
    80006398:	cf89                	beqz	a5,800063b2 <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    ...
    800063b6:	a7a080e7          	jalr	-1414(ra) # 80000e2c <mycpu>
  return (x & SSTATUS_SIE) != 0;
    800063ba:	8085                	srli	s1,s1,0x1
    800063bc:	8885                	andi	s1,s1,1
    800063be:	dd64                	sw	s1,124(a0)
    800063c0:	bfe9                	j	8000639a <push_off+0x24>

00000000800063c2 <acquire>:
{
  ...
  push_off(); // disable interrupts to avoid deadlock.
    ...
    800063d2:	fa8080e7          	jalr	-88(ra) # 80006376 <push_off>
  if(holding(lk))
    800063d6:	8526                	mv	a0,s1
    800063d8:	00000097          	auipc	ra,0x0
    800063dc:	f70080e7          	jalr	-144(ra) # 80006348 <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0)
    800063e0:	4705                	li	a4,1
  if(holding(lk))
    800063e2:	e115                	bnez	a0,80006406 <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0)
    800063e4:	87ba                	mv	a5,a4
    800063e6:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    800063ea:	2781                	sext.w	a5,a5
    800063ec:	ffe5                	bnez	a5,800063e4 <acquire+0x22>
  __sync_synchronize();
    800063ee:	0ff0000f          	fence
  lk->cpu = mycpu();
    800063f2:	ffffb097          	auipc	ra,0xffffb
    800063f6:	a3a080e7          	jalr	-1478(ra) # 80000e2c <mycpu>
    800063fa:	e888                	sd	a0,16(s1)
}
    ...
    8000640a:	49250513          	addi	a0,a0,1170 # 80008898 <digits+0x20>
    8000640e:	00000097          	auipc	ra,0x0
    80006412:	a6a080e7          	jalr	-1430(ra) # 80005e78 <panic>

0000000080006416 <pop_off>:
...
pop_off(void)
{
  ...
  struct cpu *c = mycpu();
    ...
    80006422:	a0e080e7          	jalr	-1522(ra) # 80000e2c <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80006426:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    8000642a:	8b89                	andi	a5,a5,2
  if(intr_get())
    8000642c:	e78d                	bnez	a5,80006456 <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    8000642e:	5d3c                	lw	a5,120(a0)
    80006430:	02f05b63          	blez	a5,80006466 <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
  ...
  if(c->noff == 0 && c->intena)
    8000643c:	eb09                	bnez	a4,8000644e <pop_off+0x38>
    8000643e:	5d7c                	lw	a5,124(a0)
    80006440:	c799                	beqz	a5,8000644e <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80006442:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    80006446:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    8000644a:	10079073          	csrw	sstatus,a5
    intr_on();
}
    8000644e:	60a2                	ld	ra,8(sp)
    80006450:	6402                	ld	s0,0(sp)
    80006452:	0141                	addi	sp,sp,16
    80006454:	8082                	ret
    panic("pop_off - interruptible");
    80006456:	00002517          	auipc	a0,0x2
    8000645a:	44a50513          	addi	a0,a0,1098 # 800088a0 <digits+0x28>
    8000645e:	00000097          	auipc	ra,0x0
    80006462:	a1a080e7          	jalr	-1510(ra) # 80005e78 <panic>
    panic("pop_off");
    80006466:	00002517          	auipc	a0,0x2
    8000646a:	45250513          	addi	a0,a0,1106 # 800088b8 <digits+0x40>
    8000646e:	00000097          	auipc	ra,0x0
    80006472:	a0a080e7          	jalr	-1526(ra) # 80005e78 <panic>

0000000080006476 <release>:
{
  ...
  if(!holding(lk))
    ...
    80006486:	ec6080e7          	jalr	-314(ra) # 80006348 <holding>
    8000648a:	c115                	beqz	a0,800064ae <release+0x38>
  lk->cpu = 0;
    8000648c:	0004b823          	sd	zero,16(s1)
  __sync_synchronize();
    80006490:	0ff0000f          	fence
  __sync_lock_release(&lk->locked);
    80006494:	0f50000f          	fence	iorw,ow
    80006498:	0804a02f          	amoswap.w	zero,zero,(s1)
  pop_off();
    8000649c:	00000097          	auipc	ra,0x0
    800064a0:	f7a080e7          	jalr	-134(ra) # 80006416 <pop_off>
}
    ...
    800064b2:	41250513          	addi	a0,a0,1042 # 800088c0 <digits+0x48>
    800064b6:	00000097          	auipc	ra,0x0
    800064ba:	9c2080e7          	jalr	-1598(ra) # 80005e78 <panic>
	...
